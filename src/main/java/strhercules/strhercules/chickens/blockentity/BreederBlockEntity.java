...
public class BreederBlockEntity extends AbstractChickenContainerBlockEntity {
    ...
    protected int getTargetCycleTicks() {
        strhercules.chickens.ChickensRegistryItem left = strhercules.chickens.item.ChickenItemHelper.resolve(getItem(LEFT_CHICKEN_SLOT));
        strhercules.chickens.ChickensRegistryItem right = strhercules.chickens.item.ChickenItemHelper.resolve(getItem(RIGHT_CHICKEN_SLOT));
        int tier = 1;
