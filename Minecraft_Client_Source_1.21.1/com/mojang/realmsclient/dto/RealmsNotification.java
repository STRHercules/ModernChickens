...
public class RealmsNotification {
   ...
   private static RealmsNotification parse(JsonObject var0) {
      ...
      if (var1 == null) {
         ...
         case 1217648798:
            if (var4.equals("infoPopup")) {
               var7 = 1;
            }
            break;
         case 1584658468:
            if (var4.equals("visitUrl")) {
               var7 = 0;
            }
         }
         ...
         switch(var7) {
         case 0:
            var10000 = RealmsNotification.VisitUrl.parse(var5, var0);
            break;
         case 1:
            var10000 = RealmsNotification.InfoPopup.parse(var5, var0);
            break;
         default:
            var10000 = var5;
         }
   ...
   public static class InfoPopup extends RealmsNotification {
      ...
      public static RealmsNotification.InfoPopup parse(RealmsNotification var0, JsonObject var1) {
         ...
         RealmsNotification.UrlButton var5 = (RealmsNotification.UrlButton)JsonUtils.getOptional("urlButton", var1, RealmsNotification.UrlButton::parse);
   ...
   private static record UrlButton(String url, RealmsText urlText) {
      ...
      private UrlButton(String param1, RealmsText param2) {
         super();
         this.url = var1;
         this.urlText = var2;
      }
