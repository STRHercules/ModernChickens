...
public class RealmsAvailability {
   ...
   private static CompletableFuture<RealmsAvailability.Result> check() {
      ...
      return var0.getType() != User.Type.MSA ? CompletableFuture.completedFuture(new RealmsAvailability.Result(RealmsAvailability.Type.AUTHENTICATION_ERROR)) : CompletableFuture.supplyAsync(() -> {
