...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.invitedList = (RealmsPlayerScreen.InvitedObjectSelectionList)this.layout.addToContents(new RealmsPlayerScreen.InvitedObjectSelectionList());
   ...
   private class Entry extends ContainerObjectSelectionList.Entry<RealmsPlayerScreen.Entry> {
