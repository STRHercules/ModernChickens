...
public class RegistrySetBuilder {
   ...
   private static HolderLookup.Provider buildProviderWithContext(RegistrySetBuilder.UniversalOwner var0, RegistryAccess var1, Stream<HolderLookup.RegistryLookup<?>> var2) {
      ...
      record 1Entry<T>(HolderLookup.RegistryLookup<T> lookup, RegistryOps.RegistryInfo<T> opsInfo) {
         _Entry/* $FF was: 1Entry*/(HolderLookup.RegistryLookup<T> param1, RegistryOps.RegistryInfo<T> param2) {
            super();
            this.lookup = var1;
            this.opsInfo = var2;
         }
         ...
         public static <T> 1Entry<T> createForNewRegistry(RegistrySetBuilder.UniversalOwner var0, HolderLookup.RegistryLookup<T> var1) {
            return new 1Entry(new RegistrySetBuilder.EmptyTagLookupWrapper(var0.cast(), var1), new RegistryOps.RegistryInfo(var0.cast(), var1, var1.registryLifecycle()));
         }
   ...
   private HolderLookup.Provider createLazyFullPatchedRegistries(RegistryAccess var1, HolderLookup.Provider var2, Cloner.Factory var3, Map<ResourceKey<? extends Registry<?>>, RegistrySetBuilder.RegistryContents<?>> var4, HolderLookup.Provider var5) {
   ...
   public RegistrySetBuilder.PatchedRegistries buildPatch(RegistryAccess var1, HolderLookup.Provider var2, Cloner.Factory var3) {
      ...
      var2.listRegistries().filter((var1x) -> {
         ...
         var5.putIfAbsent(var1x, new RegistrySetBuilder.RegistryContents(var1x, Lifecycle.stable(), Map.of()));
      });
   ...
   private static record RegistryStub<T>(ResourceKey<? extends Registry<T>> key, Lifecycle lifecycle, RegistrySetBuilder.RegistryBootstrap<T> bootstrap) {
      RegistryStub(ResourceKey<? extends Registry<T>> param1, Lifecycle param2, RegistrySetBuilder.RegistryBootstrap<T> param3) {
         super();
         this.key = var1;
         this.lifecycle = var2;
         this.bootstrap = var3;
   ...
   private static record BuildState(RegistrySetBuilder.UniversalOwner owner, RegistrySetBuilder.UniversalLookup lookup, Map<ResourceLocation, HolderGetter<?>> registries, Map<ResourceKey<?>, RegistrySetBuilder.RegisteredValue<?>> registeredValues, List<RuntimeException> errors) {
      ...
      private BuildState(RegistrySetBuilder.UniversalOwner param1, RegistrySetBuilder.UniversalLookup param2, Map<ResourceLocation, HolderGetter<?>> param3, Map<ResourceKey<?>, RegistrySetBuilder.RegisteredValue<?>> param4, List<RuntimeException> param5) {
         super();
         this.owner = var1;
         this.lookup = var2;
      ...
      public RegistrySetBuilder.UniversalOwner owner() {
         return this.owner;
      }
   ...
   public static record PatchedRegistries(HolderLookup.Provider full, HolderLookup.Provider patches) {
      public PatchedRegistries(HolderLookup.Provider param1, HolderLookup.Provider param2) {
         super();
         this.full = var1;
         this.patches = var2;
      }
   ...
   private static record RegistryContents<T>(ResourceKey<? extends Registry<? extends T>> key, Lifecycle lifecycle, Map<ResourceKey<T>, RegistrySetBuilder.ValueAndHolder<T>> values) {
      ...
      RegistryContents(ResourceKey<? extends Registry<? extends T>> param1, Lifecycle param2, Map<ResourceKey<T>, RegistrySetBuilder.ValueAndHolder<T>> param3) {
         super();
         this.key = var1;
         this.lifecycle = var2;
         this.values = var3;
      ...
      public HolderLookup.RegistryLookup<T> buildAsLookup(RegistrySetBuilder.UniversalOwner var1) {
         Map var2 = (Map)this.values.entrySet().stream().collect(Collectors.toUnmodifiableMap(Entry::getKey, (var1x) -> {
   ...
   private static record ValueAndHolder<T>(RegistrySetBuilder.RegisteredValue<T> value, Optional<Holder.Reference<T>> holder) {
      ValueAndHolder(RegistrySetBuilder.RegisteredValue<T> param1, Optional<Holder.Reference<T>> param2) {
         super();
         this.value = var1;
         this.holder = var2;
      }
   ...
   private static record RegisteredValue<T>(T value, Lifecycle lifecycle) {
      ...
      RegisteredValue(T param1, Lifecycle param2) {
         super();
         this.value = var1;
         this.lifecycle = var2;
      }
