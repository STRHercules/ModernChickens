   ...
   public static class Builder {
      ...
      private static DataComponentMap buildFromMapTrusted(Map<DataComponentType<?>, Object> var0) {
         if (var0.isEmpty()) {
            ...
            return var0.size() < 8 ? new DataComponentMap.Builder.SimpleMap(new Reference2ObjectArrayMap(var0)) : new DataComponentMap.Builder.SimpleMap(new Reference2ObjectOpenHashMap(var0));
         }
      }

      private static record SimpleMap(Reference2ObjectMap<DataComponentType<?>, Object> map) implements DataComponentMap {
         SimpleMap(Reference2ObjectMap<DataComponentType<?>, Object> param1) {
            super();
            this.map = var1;
         }
