...
public class BlockPos extends Vec3i {
   ...
   public Vec3 clampLocationWithin(Vec3 var1) {
      return new Vec3(Mth.clamp(var1.x, (double)((float)this.getX() + 1.0E-5F), (double)this.getX() + 1.0D - 9.999999747378752E-6D), Mth.clamp(var1.y, (double)((float)this.getY() + 1.0E-5F), (double)this.getY() + 1.0D - 9.999999747378752E-6D), Mth.clamp(var1.z, (double)((float)this.getZ() + 1.0E-5F), (double)this.getZ() + 1.0D - 9.999999747378752E-6D));
   }
   ...
   // $FF: synthetic method
   public Vec3i cross(final Vec3i param1) {
      return this.cross(var1);
   }

   // $FF: synthetic method
   public Vec3i relative(final Direction.Axis param1, final int param2) {
      return this.relative(var1, var2);
   }

   // $FF: synthetic method
   public Vec3i relative(final Direction param1, final int param2) {
      return this.relative(var1, var2);
   }

   // $FF: synthetic method
   public Vec3i relative(final Direction param1) {
      return this.relative(var1);
   }

   // $FF: synthetic method
   public Vec3i east(final int param1) {
   ...
   // $FF: synthetic method
   public Vec3i west(final int param1) {
   ...
   // $FF: synthetic method
   public Vec3i south(final int param1) {
   ...
   // $FF: synthetic method
   public Vec3i north(final int param1) {
   ...
   // $FF: synthetic method
   public Vec3i below(final int param1) {
   ...
   // $FF: synthetic method
   public Vec3i above(final int param1) {
   ...
   // $FF: synthetic method
   public Vec3i multiply(final int param1) {
      return this.multiply(var1);
   }

   // $FF: synthetic method
   public Vec3i subtract(final Vec3i param1) {
      return this.subtract(var1);
   }

   // $FF: synthetic method
   public Vec3i offset(final Vec3i param1) {
      return this.offset(var1);
   }

   // $FF: synthetic method
   public Vec3i offset(final int param1, final int param2, final int param3) {
   ...
   public static class MutableBlockPos extends BlockPos {
      ...
      public BlockPos.MutableBlockPos clamp(Direction.Axis var1, int var2, int var3) {
         ...
         default:
            throw new IllegalStateException("Unable to clamp axis " + String.valueOf(var1));
         }
      }
      ...
      // $FF: synthetic method
      public Vec3i setZ(final int param1) {
         return this.setZ(var1);
      }

      // $FF: synthetic method
      public Vec3i setY(final int param1) {
         return this.setY(var1);
      }

      // $FF: synthetic method
      public Vec3i setX(final int param1) {
