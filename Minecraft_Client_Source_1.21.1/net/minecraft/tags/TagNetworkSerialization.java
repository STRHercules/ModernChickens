...
public class TagNetworkSerialization {
   ...
   public static Map<ResourceKey<? extends Registry<?>>, TagNetworkSerialization.NetworkPayload> serializeTagsToNetwork(LayeredRegistryAccess<RegistryLayer> var0) {
      return (Map)RegistrySynchronization.networkSafeRegistries(var0).map((var0x) -> {
         ...
         return ((TagNetworkSerialization.NetworkPayload)var0x.getSecond()).size() > 0;
   ...
   static <T> void deserializeTagsFromNetwork(ResourceKey<? extends Registry<T>> var0, Registry<T> var1, TagNetworkSerialization.NetworkPayload var2, TagNetworkSerialization.TagOutput<T> var3) {
