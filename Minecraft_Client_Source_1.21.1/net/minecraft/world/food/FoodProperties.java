...
public record FoodProperties(int nutrition, float saturation, boolean canAlwaysEat, float eatSeconds, Optional<ItemStack> usingConvertsTo, List<FoodProperties.PossibleEffect> effects) {
   ...
   public FoodProperties(int param1, float param2, boolean param3, float param4, Optional<ItemStack> param5, List<FoodProperties.PossibleEffect> param6) {
      super();
      this.nutrition = var1;
   ...
   public static record PossibleEffect(MobEffectInstance effect, float probability) {
      public static final Codec<FoodProperties.PossibleEffect> CODEC = RecordCodecBuilder.create((var0) -> {
         return var0.group(MobEffectInstance.CODEC.fieldOf("effect").forGetter(FoodProperties.PossibleEffect::effect), Codec.floatRange(0.0F, 1.0F).optionalFieldOf("probability", 1.0F).forGetter(FoodProperties.PossibleEffect::probability)).apply(var0, FoodProperties.PossibleEffect::new);
      });
      public static final StreamCodec<RegistryFriendlyByteBuf, FoodProperties.PossibleEffect> STREAM_CODEC;

      public PossibleEffect(MobEffectInstance param1, float param2) {
         super();
         this.effect = var1;
      ...
      static {
         STREAM_CODEC = StreamCodec.composite(MobEffectInstance.STREAM_CODEC, FoodProperties.PossibleEffect::effect, ByteBufCodecs.FLOAT, FoodProperties.PossibleEffect::probability, FoodProperties.PossibleEffect::new);
      }
   }
