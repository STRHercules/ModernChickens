...
public class PortalShape {
   ...
   public static Vec3 getRelativePosition(BlockUtil.FoundRectangle var0, Direction.Axis var1, Vec3 var2, EntityDimensions var3) {
      ...
      double var11;
      if (var4 > 0.0D) {
         var11 = (double)var8.get(var1) + (double)var3.width() / 2.0D;
         var9 = Mth.clamp(Mth.inverseLerp(var2.get(var1) - var11, 0.0D, var4), 0.0D, 1.0D);
      } else {
         var9 = 0.5D;
      }
      ...
      if (var6 > 0.0D) {
         ...
         var11 = Mth.clamp(Mth.inverseLerp(var2.get(var13) - (double)var8.get(var13), 0.0D, var6), 0.0D, 1.0D);
      } else {
         var11 = 0.0D;
      }
