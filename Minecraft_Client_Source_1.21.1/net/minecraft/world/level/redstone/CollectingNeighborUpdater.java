...
public class CollectingNeighborUpdater implements NeighborUpdater {
   ...
   private static record ShapeUpdate(Direction direction, BlockState state, BlockPos pos, BlockPos neighborPos, int updateFlags, int updateLimit) implements CollectingNeighborUpdater.NeighborUpdates {
      ShapeUpdate(Direction param1, BlockState param2, BlockPos param3, BlockPos param4, int param5, int param6) {
         super();
         this.direction = var1;
         this.state = var2;
         this.pos = var3;
   ...
   static record SimpleNeighborUpdate(BlockPos pos, Block block, BlockPos neighborPos) implements CollectingNeighborUpdater.NeighborUpdates {
      SimpleNeighborUpdate(BlockPos param1, Block param2, BlockPos param3) {
         super();
         this.pos = var1;
         this.block = var2;
   ...
   static record FullNeighborUpdate(BlockState state, BlockPos pos, Block block, BlockPos neighborPos, boolean movedByPiston) implements CollectingNeighborUpdater.NeighborUpdates {
      FullNeighborUpdate(BlockState param1, BlockPos param2, Block param3, BlockPos param4, boolean param5) {
         super();
         this.state = var1;
         this.pos = var2;
         this.block = var3;
