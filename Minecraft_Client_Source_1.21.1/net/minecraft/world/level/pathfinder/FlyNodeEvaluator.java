...
public class FlyNodeEvaluator extends WalkNodeEvaluator {
   ...
   private Iterable<BlockPos> iteratePathfindingStartNodeCandidatePositions(Mob var1) {
      ...
      boolean var3 = var2.getSize() < 1.0D;
      if (!var3) {
         ...
         double var4 = Math.max(0.0D, 1.100000023841858D - var2.getZsize());
         double var6 = Math.max(0.0D, 1.100000023841858D - var2.getXsize());
         double var8 = Math.max(0.0D, 1.100000023841858D - var2.getYsize());
