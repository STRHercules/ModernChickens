...
public class Explosion {
   ...
   public Explosion(Level var1, @Nullable Entity var2, double var3, double var5, double var7, float var9, List<BlockPos> var10, Explosion.BlockInteraction var11, ParticleOptions var12, ParticleOptions var13, Holder<SoundEvent> var14) {
   ...
   public Explosion(Level var1, @Nullable Entity var2, @Nullable DamageSource var3, @Nullable ExplosionDamageCalculator var4, double var5, double var7, double var9, float var11, boolean var12, Explosion.BlockInteraction var13, ParticleOptions var14, ParticleOptions var15, Holder<SoundEvent> var16) {
      super();
   ...
   public void explode() {
      ...
      var4 = Mth.floor(this.x - (double)var30 - 1.0D);
      var5 = Mth.floor(this.x + (double)var30 + 1.0D);
      int var31 = Mth.floor(this.y - (double)var30 - 1.0D);
      int var7 = Mth.floor(this.y + (double)var30 + 1.0D);
      int var32 = Mth.floor(this.z - (double)var30 - 1.0D);
      int var9 = Mth.floor(this.z + (double)var30 + 1.0D);
      ...
      while(true) {
         ...
         double var37 = (1.0D - var35) * (double)getSeenPercent(var11, var13) * (double)this.damageCalculator.getKnockbackMultiplier(var13);
         double var26;
         if (var13 instanceof LivingEntity) {
            LivingEntity var28 = (LivingEntity)var13;
            var26 = var37 * (1.0D - var28.getAttributeValue(Attributes.EXPLOSION_KNOCKBACK_RESISTANCE));
         } else {
            var26 = var37;
         }
   ...
   public void finalizeExplosion(boolean var1) {
      ...
      if (var1) {
         ...
         this.level.addParticle(var3, this.x, this.y, this.z, 1.0D, 0.0D, 0.0D);
      }
