...
public class MapItemSavedData extends SavedData {
   ...
   public static MapItemSavedData load(CompoundTag var0, HolderLookup.Provider var1) {
      ...
      while(var13.hasNext()) {
         ...
         var9.addDecoration(var14.getDecoration(), (LevelAccessor)null, var14.getId(), (double)var14.pos().getX(), (double)var14.pos().getZ(), 180.0D, (Component)var14.name().orElse((Object)null));
      }
