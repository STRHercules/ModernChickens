...
public enum VaultState implements StringRepresentable {
   ...
   private void ejectResultItem(ServerLevel var1, BlockPos var2, ItemStack var3, float var4) {
      DefaultDispenseItemBehavior.spawnItem(var1, var3, 2, Direction.UP, Vec3.atBottomCenterOf(var2).relative(Direction.UP, 1.2D));
   ...
   private static enum LightLevel {
      ...
      // $FF: synthetic method
      private static VaultState.LightLevel[] $values() {
         return new VaultState.LightLevel[]{HALF_LIT, LIT};
      }
   }
}
