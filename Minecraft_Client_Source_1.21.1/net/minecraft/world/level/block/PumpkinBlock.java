...
public class PumpkinBlock extends Block {
   ...
   protected ItemInteractionResult useItemOn(ItemStack var1, BlockState var2, Level var3, BlockPos var4, Player var5, InteractionHand var6, BlockHitResult var7) {
      if (!var1.is(Items.SHEARS)) {
         ...
         ItemEntity var10 = new ItemEntity(var3, (double)var4.getX() + 0.5D + (double)var9.getStepX() * 0.65D, (double)var4.getY() + 0.1D, (double)var4.getZ() + 0.5D + (double)var9.getStepZ() * 0.65D, new ItemStack(Items.PUMPKIN_SEEDS, 4));
         var10.setDeltaMovement(0.05D * (double)var9.getStepX() + var3.random.nextDouble() * 0.02D, 0.05D, 0.05D * (double)var9.getStepZ() + var3.random.nextDouble() * 0.02D);
