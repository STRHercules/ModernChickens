...
public record BlockSetType(String name, boolean canOpenByHand, boolean canOpenByWindCharge, boolean canButtonBeActivatedByArrows, BlockSetType.PressurePlateSensitivity pressurePlateSensitivity, SoundType soundType, SoundEvent doorClose, SoundEvent doorOpen, SoundEvent trapdoorClose, SoundEvent trapdoorOpen, SoundEvent pressurePlateClickOff, SoundEvent pressurePlateClickOn, SoundEvent buttonClickOff, SoundEvent buttonClickOn) {
   ...
   public BlockSetType(String param1, boolean param2, boolean param3, boolean param4, BlockSetType.PressurePlateSensitivity param5, SoundType param6, SoundEvent param7, SoundEvent param8, SoundEvent param9, SoundEvent param10, SoundEvent param11, SoundEvent param12, SoundEvent param13, SoundEvent param14) {
      super();
      this.name = var1;
   ...
   public BlockSetType.PressurePlateSensitivity pressurePlateSensitivity() {
   ...
   public static enum PressurePlateSensitivity {
      ...
      // $FF: synthetic method
      private static BlockSetType.PressurePlateSensitivity[] $values() {
         return new BlockSetType.PressurePlateSensitivity[]{EVERYTHING, MOBS};
      }
   }
}
