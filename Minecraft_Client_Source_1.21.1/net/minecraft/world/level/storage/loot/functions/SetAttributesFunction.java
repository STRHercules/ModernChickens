...
public class SetAttributesFunction extends LootItemConditionalFunction {
   ...
   private ItemAttributeModifiers updateModifiers(LootContext var1, ItemAttributeModifiers var2) {
      ...
      SetAttributesFunction.Modifier var5;
      ...
      for(Iterator var4 = this.modifiers.iterator(); var4.hasNext(); var2 = var2.withModifierAdded(var5.attribute, new AttributeModifier(var5.id, (double)var5.amount.getFloat(var1), var5.operation), var6)) {
         var5 = (SetAttributesFunction.Modifier)var4.next();
   ...
   public static SetAttributesFunction.ModifierBuilder modifier(ResourceLocation var0, Holder<Attribute> var1, AttributeModifier.Operation var2, NumberProvider var3) {
   ...
   private static record Modifier(ResourceLocation id, Holder<Attribute> attribute, AttributeModifier.Operation operation, NumberProvider amount, List<EquipmentSlotGroup> slots) {
      ...
      public static final Codec<SetAttributesFunction.Modifier> CODEC;

      Modifier(ResourceLocation param1, Holder<Attribute> param2, AttributeModifier.Operation param3, NumberProvider param4, List<EquipmentSlotGroup> param5) {
         super();
         this.id = var1;
         this.attribute = var2;
         this.operation = var3;
      ...
      static {
         ...
         CODEC = RecordCodecBuilder.create((var0) -> {
            return var0.group(ResourceLocation.CODEC.fieldOf("id").forGetter(SetAttributesFunction.Modifier::id), Attribute.CODEC.fieldOf("attribute").forGetter(SetAttributesFunction.Modifier::attribute), AttributeModifier.Operation.CODEC.fieldOf("operation").forGetter(SetAttributesFunction.Modifier::operation), NumberProviders.CODEC.fieldOf("amount").forGetter(SetAttributesFunction.Modifier::amount), SLOTS_CODEC.fieldOf("slot").forGetter(SetAttributesFunction.Modifier::slots)).apply(var0, SetAttributesFunction.Modifier::new);
         });
      }
   }
