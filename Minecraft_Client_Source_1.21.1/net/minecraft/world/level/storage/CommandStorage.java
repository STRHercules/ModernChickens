...
public class CommandStorage {
   ...
   public CompoundTag get(ResourceLocation var1) {
      ...
      CommandStorage.Container var3 = (CommandStorage.Container)this.storage.get(this.factory(var2), createId(var2));
   ...
   public void set(ResourceLocation var1, CompoundTag var2) {
      ...
      ((CommandStorage.Container)this.storage.computeIfAbsent(this.factory(var3), createId(var3))).put(var1.getPath(), var2);
   }
