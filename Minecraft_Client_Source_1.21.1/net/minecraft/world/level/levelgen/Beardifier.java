   ...
   public double compute(DensityFunction.FunctionContext var1) {
      ...
      for(var5 = 0.0D; this.pieceIterator.hasNext(); var5 += var10001) {
         ...
         case NONE:
            ...
            break;
         case BURY:
            var10001 = getBuryContribution((double)var10, (double)var14 / 2.0D, (double)var11);
            break;
         case BEARD_THIN:
         case BEARD_BOX:
            ...
            break;
         case ENCAPSULATE:
            var10001 = getBuryContribution((double)var10 / 2.0D, (double)var14 / 2.0D, (double)var11 / 2.0D) * 0.8D;
            break;
         default:
            throw new MatchException((String)null, (Throwable)null);
         }
