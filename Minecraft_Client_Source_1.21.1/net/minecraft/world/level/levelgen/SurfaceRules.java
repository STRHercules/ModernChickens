...
public class SurfaceRules {
   ...
   private static record StoneDepthCheck(int offset, boolean addSurfaceDepth, int secondaryDepthRange, CaveSurface surfaceType) implements SurfaceRules.ConditionSource {
      ...
      StoneDepthCheck(int param1, boolean param2, int param3, CaveSurface param4) {
         super();
         this.offset = var1;
      ...
      // $FF: synthetic method
      public Object apply(final Object param1) {
   ...
   static record NotConditionSource(SurfaceRules.ConditionSource target) implements SurfaceRules.ConditionSource {
      ...
      NotConditionSource(SurfaceRules.ConditionSource param1) {
         super();
         this.target = var1;
      }
   ...
   private static record YConditionSource(VerticalAnchor anchor, int surfaceDepthMultiplier, boolean addStoneDepth) implements SurfaceRules.ConditionSource {
      ...
      YConditionSource(VerticalAnchor param1, int param2, boolean param3) {
         super();
         this.anchor = var1;
   ...
   private static record WaterConditionSource(int offset, int surfaceDepthMultiplier, boolean addStoneDepth) implements SurfaceRules.ConditionSource {
      ...
      WaterConditionSource(int param1, int param2, boolean param3) {
         super();
         this.offset = var1;
         this.surfaceDepthMultiplier = var2;
         this.addStoneDepth = var3;
   ...
   private static record NoiseThresholdConditionSource(ResourceKey<NormalNoise.NoiseParameters> noise, double minThreshold, double maxThreshold) implements SurfaceRules.ConditionSource {
      ...
      NoiseThresholdConditionSource(ResourceKey<NormalNoise.NoiseParameters> param1, double param2, double param4) {
         super();
         this.noise = var1;
   ...
   static record VerticalGradientConditionSource(ResourceLocation randomName, VerticalAnchor trueAtAndBelow, VerticalAnchor falseAtAndAbove) implements SurfaceRules.ConditionSource {
      ...
      VerticalGradientConditionSource(ResourceLocation param1, VerticalAnchor param2, VerticalAnchor param3) {
         super();
      ...
      public SurfaceRules.Condition apply(final SurfaceRules.Context var1) {
         ...
         class 1VerticalGradientCondition extends SurfaceRules.LazyYCondition {
            _VerticalGradientCondition/* $FF was: 1VerticalGradientCondition*/(final SurfaceRules.VerticalGradientConditionSource param1) {
               super(var1);
            }
   ...
   private static record TestRuleSource(SurfaceRules.ConditionSource ifTrue, SurfaceRules.RuleSource thenRun) implements SurfaceRules.RuleSource {
      ...
      TestRuleSource(SurfaceRules.ConditionSource param1, SurfaceRules.RuleSource param2) {
         super();
         this.ifTrue = var1;
         this.thenRun = var2;
      }
   ...
   private static record SequenceRuleSource(List<SurfaceRules.RuleSource> sequence) implements SurfaceRules.RuleSource {
      ...
      SequenceRuleSource(List<SurfaceRules.RuleSource> param1) {
         super();
         this.sequence = var1;
      }
   ...
   static record BlockRuleSource(BlockState resultState, SurfaceRules.StateRule rule) implements SurfaceRules.RuleSource {
      ...
      private BlockRuleSource(BlockState param1, SurfaceRules.StateRule param2) {
         super();
   ...
   private static record SequenceRule(List<SurfaceRules.SurfaceRule> rules) implements SurfaceRules.SurfaceRule {
      SequenceRule(List<SurfaceRules.SurfaceRule> param1) {
         super();
         this.rules = var1;
      }
   ...
   private static record TestRule(SurfaceRules.Condition condition, SurfaceRules.SurfaceRule followup) implements SurfaceRules.SurfaceRule {
      TestRule(SurfaceRules.Condition param1, SurfaceRules.SurfaceRule param2) {
         super();
         this.condition = var1;
         this.followup = var2;
      }
   ...
   private static record NotCondition(SurfaceRules.Condition target) implements SurfaceRules.Condition {
      NotCondition(SurfaceRules.Condition param1) {
         super();
         this.target = var1;
      }
