...
public class JigsawPlacement {
                     ...
                     if (((StructureTemplatePool)var27.value()).size() == 0 && !var27.is(Pools.EMPTY)) {
                        ...
                        while(var32.hasNext()) {
                           ...
                           while(var34.hasNext()) {
                              ...
                              } while(Shapes.joinIsNotEmpty((VoxelShape)var28.getValue(), Shapes.create(AABB.of(var51).deflate(0.25D)), BooleanOp.ONLY_SECOND));
   ...
   static record PieceState(PoolElementStructurePiece piece, MutableObject<VoxelShape> free, int depth) {
      ...
      PieceState(PoolElementStructurePiece param1, MutableObject<VoxelShape> param2, int param3) {
         super();
         this.piece = var1;
         this.free = var2;
         this.depth = var3;
