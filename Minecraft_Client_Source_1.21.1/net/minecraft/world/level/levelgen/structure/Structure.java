...
public abstract class Structure {
   ...
   public static record StructureSettings(HolderSet<Biome> biomes, Map<MobCategory, StructureSpawnOverride> spawnOverrides, GenerationStep.Decoration step, TerrainAdjustment terrainAdaptation) {
      ...
      static final Structure.StructureSettings DEFAULT;
      public static final MapCodec<Structure.StructureSettings> CODEC;

      public StructureSettings(HolderSet<Biome> var1) {
         this(var1, DEFAULT.spawnOverrides, DEFAULT.step, DEFAULT.terrainAdaptation);
      }

      public StructureSettings(HolderSet<Biome> param1, Map<MobCategory, StructureSpawnOverride> param2, GenerationStep.Decoration param3, TerrainAdjustment param4) {
         super();
         this.biomes = var1;
      ...
      static {
         DEFAULT = new Structure.StructureSettings(HolderSet.direct(), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.NONE);
         CODEC = RecordCodecBuilder.mapCodec((var0) -> {
            return var0.group(RegistryCodecs.homogeneousList(Registries.BIOME).fieldOf("biomes").forGetter(Structure.StructureSettings::biomes), Codec.simpleMap(MobCategory.CODEC, StructureSpawnOverride.CODEC, StringRepresentable.keys(MobCategory.values())).fieldOf("spawn_overrides").forGetter(Structure.StructureSettings::spawnOverrides), GenerationStep.Decoration.CODEC.fieldOf("step").forGetter(Structure.StructureSettings::step), TerrainAdjustment.CODEC.optionalFieldOf("terrain_adaptation", DEFAULT.terrainAdaptation).forGetter(Structure.StructureSettings::terrainAdaptation)).apply(var0, Structure.StructureSettings::new);
         });
      }
      ...
      public static class Builder {
         ...
         public Structure.StructureSettings.Builder spawnOverrides(Map<MobCategory, StructureSpawnOverride> var1) {
            this.spawnOverrides = var1;
            return this;
         }

         public Structure.StructureSettings.Builder generationStep(GenerationStep.Decoration var1) {
            this.step = var1;
            return this;
         }

         public Structure.StructureSettings.Builder terrainAdapation(TerrainAdjustment var1) {
   ...
   public static record GenerationContext(RegistryAccess registryAccess, ChunkGenerator chunkGenerator, BiomeSource biomeSource, RandomState randomState, StructureTemplateManager structureTemplateManager, WorldgenRandom random, long seed, ChunkPos chunkPos, LevelHeightAccessor heightAccessor, Predicate<Holder<Biome>> validBiome) {
      ...
      public GenerationContext(RegistryAccess param1, ChunkGenerator param2, BiomeSource param3, RandomState param4, StructureTemplateManager param5, WorldgenRandom param6, long param7, ChunkPos param9, LevelHeightAccessor param10, Predicate<Holder<Biome>> param11) {
         super();
   ...
   public static record GenerationStub(BlockPos position, Either<Consumer<StructurePiecesBuilder>, StructurePiecesBuilder> generator) {
      ...
      public GenerationStub(BlockPos param1, Either<Consumer<StructurePiecesBuilder>, StructurePiecesBuilder> param2) {
         super();
         this.position = var1;
         this.generator = var2;
      }
