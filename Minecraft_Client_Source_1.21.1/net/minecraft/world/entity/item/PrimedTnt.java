...
public class PrimedTnt extends Entity implements TraceableEntity {
   ...
   private void explode() {
      float var1 = 4.0F;
      this.level().explode(this, Explosion.getDefaultDamageSource(this.level(), this), this.usedPortal ? USED_PORTAL_DAMAGE_CALCULATOR : null, this.getX(), this.getY(0.0625D), this.getZ(), 4.0F, false, Level.ExplosionInteraction.TNT);
   }
   ...
   public void restoreFrom(Entity var1) {
      ...
      if (var1 instanceof PrimedTnt) {
         PrimedTnt var2 = (PrimedTnt)var1;
