...
public record AttributeModifier(ResourceLocation id, double amount, AttributeModifier.Operation operation) {
   ...
   public AttributeModifier(ResourceLocation param1, double param2, AttributeModifier.Operation param4) {
      super();
      this.id = var1;
      this.amount = var2;
      this.operation = var4;
   ...
   public static AttributeModifier load(CompoundTag var0) {
      ...
      if (var1.isSuccess()) {
         ...
         LOGGER.warn("Unable to create attribute: {}", ((Error)var1.error().get()).message());
         return null;
      }
   }
