...
public class Camel extends AbstractHorse implements PlayerRideableJumping, Saddleable {
   ...
   protected Vec3 getPassengerAttachmentPoint(Entity var1, EntityDimensions var2, float var3) {
      ...
      boolean var5 = var4 == 0;
      float var6 = 0.5F;
      float var7 = (float)(this.isRemoved() ? 0.009999999776482582D : this.getBodyAnchorAnimationYOffset(var5, 0.0F, var2, var3));
      ...
      return (new Vec3(0.0D, (double)var7, (double)(var6 * var3))).yRot(-this.getYRot() * 0.017453292F);
   }
   ...
   public Vec3 getLeashOffset(float var1) {
      ...
      return new Vec3(0.0D, this.getBodyAnchorAnimationYOffset(true, var1, var2, var3) - (double)(0.2F * var3), (double)(var2.width() * 0.56F));
   }
