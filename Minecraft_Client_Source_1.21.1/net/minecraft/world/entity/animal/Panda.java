...
public class Panda extends Animal {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(4, new TemptGoal(this, 1.0D, (var0) -> {
   ...
   private void afterSneeze() {
      ...
      var2.addParticle(ParticleTypes.SNEEZE, this.getX() - (double)(this.getBbWidth() + 1.0F) * 0.5D * (double)Mth.sin(this.yBodyRot * 0.017453292F), this.getEyeY() - 0.10000000149011612D, this.getZ() + (double)(this.getBbWidth() + 1.0F) * 0.5D * (double)Mth.cos(this.yBodyRot * 0.017453292F), var1.x, 0.0D, var1.z);
      this.playSound(SoundEvents.PANDA_SNEEZE, 1.0F, 1.0F);
      List var3 = var2.getEntitiesOfClass(Panda.class, this.getBoundingBox().inflate(10.0D));
