...
public final class WolfVariant {
   ...
   public int hashCode() {
      byte var1 = 1;
      int var2 = 31 * var1 + this.wildTexture.hashCode();
      var2 = 31 * var2 + this.tameTexture.hashCode();
      var2 = 31 * var2 + this.angryTexture.hashCode();
      var2 = 31 * var2 + this.biomes.hashCode();
      return var2;
   }
