...
public class Armadillo extends Animal {
   ...
   public boolean isScaredBy(LivingEntity var1) {
      if (!this.getBoundingBox().inflate(7.0D, 2.0D, 7.0D).intersects(var1.getBoundingBox())) {
         return false;
   ...
   public static enum ArmadilloState implements StringRepresentable {
      ...
      public static Armadillo.ArmadilloState fromName(String var0) {
         return (Armadillo.ArmadilloState)CODEC.byName(var0, IDLE);
      }
      ...
      // $FF: synthetic method
      private static Armadillo.ArmadilloState[] $values() {
         return new Armadillo.ArmadilloState[]{IDLE, ROLLING, SCARED, UNROLLING};
      }
   }
}
