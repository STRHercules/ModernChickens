...
public class Slime extends Mob implements Enemy {
   ...
   public void tick() {
      ...
      if (this.onGround() && !this.wasOnGround) {
         ...
         for(int var3 = 0; (float)var3 < var1 * 16.0F; ++var3) {
            ...
            this.level().addParticle(this.getParticleType(), this.getX() + (double)var6, this.getY(), this.getZ() + (double)var7, 0.0D, 0.0D, 0.0D);
         }
      ...
      if (!this.level().isClientSide && var2 > 1 && this.isDeadOrDying()) {
         ...
         for(int var9 = 0; var9 < var8; ++var9) {
            ...
            if (var12 != null) {
               ...
               var12.moveTo(this.getX() + (double)var10, this.getY() + 0.5D, this.getZ() + (double)var11, this.random.nextFloat() * 360.0F, 0.0F);
   ...
   protected Vec3 getPassengerAttachmentPoint(Entity var1, EntityDimensions var2, float var3) {
      return new Vec3(0.0D, (double)var2.height() - 0.015625D * (double)this.getSize() * (double)var3, 0.0D);
   }
