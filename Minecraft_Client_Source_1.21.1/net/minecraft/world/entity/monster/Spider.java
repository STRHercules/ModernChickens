...
public class Spider extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(2, new AvoidEntityGoal(this, Armadillo.class, 6.0F, 1.0D, 1.2D, (var0) -> {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor var1, DifficultyInstance var2, MobSpawnType var3, @Nullable SpawnGroupData var4) {
      ...
      if (var8 == null) {
         var8 = new Spider.SpiderEffectsGroupData();
         if (var1.getDifficulty() == Difficulty.HARD && var5.nextFloat() < 0.1F * var2.getSpecialMultiplier()) {
            ((Spider.SpiderEffectsGroupData)var8).setRandomEffect(var5);
         }
      }

      if (var8 instanceof Spider.SpiderEffectsGroupData) {
         Spider.SpiderEffectsGroupData var9 = (Spider.SpiderEffectsGroupData)var8;
   ...
   public Vec3 getVehicleAttachmentPoint(Entity var1) {
      return var1.getBbWidth() <= this.getBbWidth() ? new Vec3(0.0D, 0.3125D * (double)this.getScale(), 0.0D) : super.getVehicleAttachmentPoint(var1);
   }
