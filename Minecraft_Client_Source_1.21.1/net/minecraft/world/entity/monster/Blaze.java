               ...
               if (this.attackTime <= 0) {
                  ...
                  if (this.attackStep > 1) {
                     ...
                     for(int var13 = 0; var13 < 1; ++var13) {
                        Vec3 var14 = new Vec3(this.blaze.getRandom().triangle(var5, 2.297D * var11), var7, this.blaze.getRandom().triangle(var9, 2.297D * var11));
                        SmallFireball var15 = new SmallFireball(this.blaze.level(), this.blaze, var14.normalize());
                        var15.setPos(var15.getX(), this.blaze.getY(0.5D) + 0.5D, var15.getZ());
