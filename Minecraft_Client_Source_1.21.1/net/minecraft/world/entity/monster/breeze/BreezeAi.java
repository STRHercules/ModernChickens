...
public class BreezeAi {
   ...
   private static void initIdleActivity(Brain<Breeze> var0) {
      ...
      })), Pair.of(1, StartAttacking.create(Breeze::getHurtBy)), Pair.of(2, new BreezeAi.SlideToTargetSink(20, 40)), Pair.of(3, new RunOne(ImmutableList.of(Pair.of(new DoNothing(20, 100), 1), Pair.of(RandomStroll.stroll(0.6F), 2))))));
   }
