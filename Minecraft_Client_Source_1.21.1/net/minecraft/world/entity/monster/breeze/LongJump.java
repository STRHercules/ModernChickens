...
public class LongJump extends Behavior<Breeze> {
   ...
   private static BlockPos snapToSurface(LivingEntity var0, Vec3 var1) {
      ClipContext var2 = new ClipContext(var1, var1.relative(Direction.DOWN, 10.0D), ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE, var0);
      ...
      if (var3.getType() == HitResult.Type.BLOCK) {
         ...
         ClipContext var4 = new ClipContext(var1, var1.relative(Direction.UP, 10.0D), ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE, var0);
   ...
   private static boolean outOfAggroRange(Breeze var0, LivingEntity var1) {
      return !var1.closerThan(var0, 24.0D);
   }
   ...
   // $FF: synthetic method
   protected boolean checkExtraStartConditions(final ServerLevel param1, final LivingEntity param2) {
