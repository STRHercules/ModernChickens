...
public abstract class SpellcasterIllager extends AbstractIllager {
   ...
   public void tick() {
      ...
      if (this.level().isClientSide && this.isCastingSpell()) {
         ...
         double var8 = 0.6D * (double)this.getScale();
         double var10 = 1.8D * (double)this.getScale();
         this.level().addParticle(ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, var2, var3, var4), this.getX() + (double)var6 * var8, this.getY() + var10, this.getZ() + (double)var7 * var8, 0.0D, 0.0D, 0.0D);
         this.level().addParticle(ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, var2, var3, var4), this.getX() - (double)var6 * var8, this.getY() + var10, this.getZ() - (double)var7 * var8, 0.0D, 0.0D, 0.0D);
      }
