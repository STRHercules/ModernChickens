      ...
      if (this.attackTarget == null) {
         ...
         if (this.attackTarget.distanceToSqr(this.dragon) < 4096.0D) {
            if (this.dragon.hasLineOfSight(this.attackTarget)) {
               ++this.fireballCharge;
               Vec3 var26 = (new Vec3(this.attackTarget.getX() - this.dragon.getX(), 0.0D, this.attackTarget.getZ() - this.dragon.getZ())).normalize();
               ...
               float var8 = (float)(Math.acos((double)var27) * 57.2957763671875D);
               var8 += 0.5F;
               if (this.fireballCharge >= 5 && var8 >= 0.0F && var8 < 10.0F) {
                  var9 = 1.0D;
                  Vec3 var28 = this.dragon.getViewVector(1.0F);
                  double var12 = this.dragon.head.getX() - var28.x * 1.0D;
                  double var14 = this.dragon.head.getY(0.5D) + 0.5D;
                  double var16 = this.dragon.head.getZ() - var28.z * 1.0D;
