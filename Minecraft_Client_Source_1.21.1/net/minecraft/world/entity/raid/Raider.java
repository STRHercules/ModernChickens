...
public abstract class Raider extends PatrollingMonster {
   ...
   public class ObtainRaidLeaderBannerGoal<T extends Raider> extends Goal {
      ...
      public ObtainRaidLeaderBannerGoal(final Raider param1, final Raider param2) {
         super();
         this.mob = var2;
   ...
   protected class HoldGroundAttackGoal extends Goal {
      ...
      public HoldGroundAttackGoal(final Raider param1, final AbstractIllager param2, final float param3) {
         super();
         this.mob = var2;
