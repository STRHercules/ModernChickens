...
public class AreaEffectCloud extends Entity implements TraceableEntity {
   ...
   private void updateColor() {
      ...
      if (var1 instanceof ColorParticleOption) {
         ColorParticleOption var2 = (ColorParticleOption)var1;
      ...
      if (this.level().isClientSide) {
         ...
         for(int var6 = 0; var6 < var4; ++var6) {
            ...
            if (var3.getType() == ParticleTypes.ENTITY_EFFECT) {
               if (var1 && this.random.nextBoolean()) {
                  this.level().addAlwaysVisibleParticle(ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, -1), var9, var11, var13, 0.0D, 0.0D, 0.0D);
               } else {
                  ...
                  while(true) {
                     ...
                     while(var14.hasNext()) {
                        ...
                        if (((MobEffect)var15.getEffect().value()).isInstantenous()) {
                           ((MobEffect)var15.getEffect().value()).applyInstantenousEffect(this, this.getOwner(), var22, var15.getAmplifier(), 0.5D);
                        } else {
