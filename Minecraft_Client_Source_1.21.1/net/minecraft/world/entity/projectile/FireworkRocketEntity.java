...
public class FireworkRocketEntity extends Projectile implements ItemSupplier {
   ...
   private void dealExplosionDamage() {
      ...
      if (var1 > 0.0F) {
         ...
         List var6 = this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(5.0D));
         ...
         while(true) {
            ...
            } while(this.distanceToSqr(var8) > 25.0D);

            boolean var9 = false;

            for(int var10 = 0; var10 < 2; ++var10) {
               Vec3 var11 = new Vec3(var8.getX(), var8.getY(0.5D * (double)var10), var8.getZ());
            ...
            if (var9) {
               float var13 = var1 * (float)Math.sqrt((5.0D - (double)this.distanceTo(var8)) / 5.0D);
