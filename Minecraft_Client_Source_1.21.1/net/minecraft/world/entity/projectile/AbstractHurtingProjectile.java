...
public abstract class AbstractHurtingProjectile extends Projectile {
   ...
   public void tick() {
      ...
      if (!this.level().isClientSide && (var1 != null && var1.isRemoved() || !this.level().hasChunkAt(this.blockPosition()))) {
         ...
         if (var13 != null) {
            this.level().addParticle(var13, var4, var6 + 0.5D, var8, 0.0D, 0.0D, 0.0D);
         }
   ...
   public Packet<ClientGamePacketListener> getAddEntityPacket(ServerEntity var1) {
      ...
      return new ClientboundAddEntityPacket(this.getId(), this.getUUID(), var4.x(), var4.y(), var4.z(), var1.getLastSentXRot(), var1.getLastSentYRot(), this.getType(), var3, var1.getLastSentMovement(), 0.0D);
   }
