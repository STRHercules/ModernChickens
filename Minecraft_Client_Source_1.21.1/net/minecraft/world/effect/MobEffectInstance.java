...
public class MobEffectInstance implements Comparable<MobEffectInstance> {
   ...
   static record Details(int amplifier, int duration, boolean ambient, boolean showParticles, boolean showIcon, Optional<MobEffectInstance.Details> hiddenEffect) {
      public static final MapCodec<MobEffectInstance.Details> MAP_CODEC = MapCodec.recursive("MobEffectInstance.Details", (var0) -> {
         return RecordCodecBuilder.mapCodec((var1) -> {
            return var1.group(ExtraCodecs.UNSIGNED_BYTE.optionalFieldOf("amplifier", 0).forGetter(MobEffectInstance.Details::amplifier), Codec.INT.optionalFieldOf("duration", 0).forGetter(MobEffectInstance.Details::duration), Codec.BOOL.optionalFieldOf("ambient", false).forGetter(MobEffectInstance.Details::ambient), Codec.BOOL.optionalFieldOf("show_particles", true).forGetter(MobEffectInstance.Details::showParticles), Codec.BOOL.optionalFieldOf("show_icon").forGetter((var0x) -> {
               return Optional.of(var0x.showIcon());
            }), var0.optionalFieldOf("hidden_effect").forGetter(MobEffectInstance.Details::hiddenEffect)).apply(var1, MobEffectInstance.Details::create);
         });
      });
      public static final StreamCodec<ByteBuf, MobEffectInstance.Details> STREAM_CODEC = StreamCodec.recursive((var0) -> {
         return StreamCodec.composite(ByteBufCodecs.VAR_INT, MobEffectInstance.Details::amplifier, ByteBufCodecs.VAR_INT, MobEffectInstance.Details::duration, ByteBufCodecs.BOOL, MobEffectInstance.Details::ambient, ByteBufCodecs.BOOL, MobEffectInstance.Details::showParticles, ByteBufCodecs.BOOL, MobEffectInstance.Details::showIcon, var0.apply(ByteBufCodecs::optional), MobEffectInstance.Details::hiddenEffect, MobEffectInstance.Details::new);
      });

      Details(int param1, int param2, boolean param3, boolean param4, boolean param5, Optional<MobEffectInstance.Details> param6) {
         super();
         this.amplifier = var1;
         this.duration = var2;
         this.ambient = var3;
      ...
      private static MobEffectInstance.Details create(int var0, int var1, boolean var2, boolean var3, Optional<Boolean> var4, Optional<MobEffectInstance.Details> var5) {
         return new MobEffectInstance.Details(var0, var1, var2, var3, (Boolean)var4.orElse(var3), var5);
      }
