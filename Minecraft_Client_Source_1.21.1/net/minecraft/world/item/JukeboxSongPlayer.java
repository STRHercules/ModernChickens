...
public class JukeboxSongPlayer {
   ...
   private static void spawnMusicParticles(LevelAccessor var0, BlockPos var1) {
      if (var0 instanceof ServerLevel) {
         ...
         Vec3 var3 = Vec3.atBottomCenterOf(var1).add(0.0D, 1.2000000476837158D, 0.0D);
         float var4 = (float)var0.getRandom().nextInt(4) / 24.0F;
         var2.sendParticles(ParticleTypes.NOTE, var3.x(), var3.y(), var3.z(), 0, (double)var4, 0.0D, 0.0D, 1.0D);
      }
