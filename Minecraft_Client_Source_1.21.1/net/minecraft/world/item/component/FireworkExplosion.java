...
public record FireworkExplosion(FireworkExplosion.Shape shape, IntList colors, IntList fadeColors, boolean hasTrail, boolean hasTwinkle) implements TooltipProvider {
   ...
   public FireworkExplosion(FireworkExplosion.Shape param1, IntList param2, IntList param3, boolean param4, boolean param5) {
      super();
      this.shape = var1;
      this.colors = var2;
   ...
   public static enum Shape implements StringRepresentable {
      ...
      private static final IntFunction<FireworkExplosion.Shape> BY_ID = ByIdMap.continuous(FireworkExplosion.Shape::getId, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
      ...
      public static FireworkExplosion.Shape byId(int var0) {
         return (FireworkExplosion.Shape)BY_ID.apply(var0);
      }
      ...
      private static FireworkExplosion.Shape[] $values() {
         return new FireworkExplosion.Shape[]{SMALL_BALL, LARGE_BALL, STAR, CREEPER, BURST};
      }
   }
}
