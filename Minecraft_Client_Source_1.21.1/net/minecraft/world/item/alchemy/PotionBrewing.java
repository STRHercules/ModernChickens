...
public class PotionBrewing {
   ...
   public boolean isContainerIngredient(ItemStack var1) {
      ...
      PotionBrewing.Mix var3;
      do {
         if (!var2.hasNext()) {
            return false;
         }

         var3 = (PotionBrewing.Mix)var2.next();
   ...
   public boolean hasContainerMix(ItemStack var1, ItemStack var2) {
      ...
      PotionBrewing.Mix var4;
      do {
         if (!var3.hasNext()) {
            return false;
         }

         var4 = (PotionBrewing.Mix)var3.next();
   ...
   public boolean hasPotionMix(ItemStack var1, ItemStack var2) {
      ...
      if (var3.isEmpty()) {
         ...
         PotionBrewing.Mix var5;
         do {
            if (!var4.hasNext()) {
               return false;
            }

            var5 = (PotionBrewing.Mix)var4.next();
   ...
   static record Mix<T>(Holder<T> from, Ingredient ingredient, Holder<T> to) {
      ...
      Mix(Holder<T> param1, Ingredient param2, Holder<T> param3) {
         super();
         this.from = var1;
