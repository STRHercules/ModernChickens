...
public class LocalPlayer extends AbstractClientPlayer {
   ...
   private void sendPosition() {
      ...
      if (this.isControlledCamera()) {
         ...
         if (this.isPassenger()) {
            ...
            this.connection.send(new ServerboundMovePlayerPacket.PosRot(var14.x, -999.0D, var14.z, this.getYRot(), this.getXRot(), this.onGround()));
            var12 = false;
         } else if (var12 && var13) {
   ...
   public void aiStep() {
      ...
      if (var4.flying && this.isControlledCamera()) {
         ...
         if (var13 != 0) {
            this.setDeltaMovement(this.getDeltaMovement().add(0.0D, (double)((float)var13 * var4.getFlyingSpeed() * 3.0F), 0.0D));
         }
      }
