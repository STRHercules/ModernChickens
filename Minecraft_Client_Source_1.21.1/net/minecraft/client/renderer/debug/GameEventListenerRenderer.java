...
public class GameEventListenerRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      if (var9 == null) {
         ...
         while(var31.hasNext()) {
            ...
            DebugRenderer.renderFloatingText(var1, var2, var32.gameEvent.location().toString(), var15.x, var15.y + 0.8500000238418579D, var15.z, -7564911, 0.0075F);
         }
   ...
   private static record TrackedGameEvent(long timeStamp, ResourceKey<GameEvent> gameEvent, Vec3 position) {
      ...
      TrackedGameEvent(long param1, ResourceKey<GameEvent> param3, Vec3 param4) {
         super();
         this.timeStamp = var1;
         this.gameEvent = var3;
         this.position = var4;
