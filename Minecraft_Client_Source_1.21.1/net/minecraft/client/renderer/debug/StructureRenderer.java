...
public class StructureRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      BlockPos var11 = BlockPos.containing(var9.getPosition().x, 0.0D, var9.getPosition().z);
      ...
      if (this.postMainBoxes.containsKey(var10)) {
         ...
         while(var13.hasNext()) {
            ...
            if (var11.closerThan(var14.getCenter(), 500.0D)) {
      ...
      if (var17 != null) {
         ...
         while(var18.hasNext()) {
            ...
            if (var11.closerThan(var16.getCenter(), 500.0D)) {
               if (var15.isStart()) {
