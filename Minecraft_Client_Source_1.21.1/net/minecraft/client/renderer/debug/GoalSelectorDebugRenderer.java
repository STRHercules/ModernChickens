...
public class GoalSelectorDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      while(true) {
         GoalSelectorDebugRenderer.EntityGoalInfo var12;
         BlockPos var13;
         do {
            if (!var11.hasNext()) {
               return;
            ...
            var12 = (GoalSelectorDebugRenderer.EntityGoalInfo)var11.next();
            var13 = var12.entityPos;
         } while(!var10.closerThan(var13, 160.0D));
         ...
         for(int var14 = 0; var14 < var12.goals.size(); ++var14) {
            ...
            double var16 = (double)var13.getX() + 0.5D;
            double var18 = (double)var13.getY() + 2.0D + (double)var14 * 0.25D;
            double var20 = (double)var13.getZ() + 0.5D;
   ...
   static record EntityGoalInfo(BlockPos entityPos, List<GoalDebugPayload.DebugGoal> goals) {
      ...
      EntityGoalInfo(BlockPos param1, List<GoalDebugPayload.DebugGoal> param2) {
         super();
         this.entityPos = var1;
         this.goals = var2;
      }
