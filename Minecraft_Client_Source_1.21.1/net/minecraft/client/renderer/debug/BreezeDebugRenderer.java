...
public class BreezeDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      var9.level().getEntities((EntityTypeTest)EntityType.BREEZE, var9.getBoundingBox().inflate(100.0D), (var0) -> {
         return true;
      }).forEach((var10) -> {
         ...
         var11.map(BreezeDebugPayload.BreezeInfo::attackTarget).map((var1x) -> {
            ...
            Vec3 var10x = var9x.add(0.0D, 0.009999999776482582D, 0.0D);
            drawCircle(var1.last().pose(), var3, var5, var7, var2.getBuffer(RenderType.debugLineStrip(2.0D)), var10x, 4.0F, INNER_CIRCLE_COLOR);
            drawCircle(var1.last().pose(), var3, var5, var7, var2.getBuffer(RenderType.debugLineStrip(2.0D)), var10x, 8.0F, MIDDLE_CIRCLE_COLOR);
            drawCircle(var1.last().pose(), var3, var5, var7, var2.getBuffer(RenderType.debugLineStrip(2.0D)), var10x, 20.0F, OUTER_CIRCLE_COLOR);
         });
