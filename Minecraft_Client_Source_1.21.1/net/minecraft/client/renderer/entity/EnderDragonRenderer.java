...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon> {
   ...
   public static class DragonModel extends EntityModel<EnderDragon> {
      ...
      public void renderToBuffer(PoseStack var1, VertexConsumer var2, int var3, int var4, int var5) {
         ...
         this.jaw.xRot = (float)(Math.sin((double)(var6 * 6.2831855F)) + 1.0D) * 0.2F;
         float var7 = (float)(Math.sin((double)(var6 * 6.2831855F - 1.0F)) + 1.0D);
         ...
         this.leftWing.zRot = -((float)(Math.sin((double)var21) + 0.125D)) * 0.8F;
         this.leftWingTip.zRot = (float)(Math.sin((double)(var21 + 2.0F)) + 0.5D) * 0.75F;
