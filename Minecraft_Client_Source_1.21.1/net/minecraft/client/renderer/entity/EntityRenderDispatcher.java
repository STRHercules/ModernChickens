...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
      ...
      try {
         ...
         if ((Boolean)this.options.entityShadows().get() && this.shouldRenderShadow && !var1.isInvisible()) {
            ...
            if (var21 > 0.0F) {
               ...
               float var24 = (float)((1.0D - var22 / 256.0D) * (double)var13.shadowStrength);
               if (var24 > 0.0F) {
   ...
   private static void renderServerSideHitbox(PoseStack var0, Entity var1, MultiBufferSource var2) {
      ...
      if (var3 == null) {
         DebugRenderer.renderFloatingText(var0, var2, "Missing", var1.getX(), var1.getBoundingBox().maxY + 1.5D, var1.getZ(), -65536);
      } else {
         var0.pushPose();
   ...
   private static void renderHitbox(PoseStack var0, VertexConsumer var1, Entity var2, float var3, float var4, float var5, float var6) {
      ...
      if (var25 != null) {
         ...
         LevelRenderer.renderLineBox(var0, var1, var11.x - (double)var9, var11.y, var11.z - (double)var9, var11.x + (double)var9, var11.y + 0.0625D, var11.z + (double)var9, 1.0F, 1.0F, 0.0F, 1.0F);
      }

      renderVector(var0, var1, new Vector3f(0.0F, var2.getEyeHeight(), 0.0F), var2.getViewVector(var3).scale(2.0D), -16776961);
   }
