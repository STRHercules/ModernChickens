...
public abstract class MobRenderer<T extends Mob, M extends EntityModel<T>> extends LivingEntityRenderer<T, M> {
   ...
   // $FF: synthetic method
   protected float getShadowRadius(final LivingEntity param1) {
      return this.getShadowRadius((Mob)var1);
   }

   // $FF: synthetic method
   protected boolean shouldShowName(final LivingEntity param1) {
      return this.shouldShowName((Mob)var1);
   }

   // $FF: synthetic method
   protected float getShadowRadius(final Entity param1) {
      return this.getShadowRadius((Mob)var1);
   }

   // $FF: synthetic method
   protected boolean shouldShowName(final Entity param1) {
      return this.shouldShowName((Mob)var1);
   }
}
