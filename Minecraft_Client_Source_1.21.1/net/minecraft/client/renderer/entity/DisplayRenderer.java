...
public abstract class DisplayRenderer<T extends Display, S> extends EntityRenderer<T> {
   ...
   private Quaternionf calculateOrientation(Display.RenderState var1, T var2, float var3, Quaternionf var4) {
      ...
      case FIXED:
         var10000 = var4.rotationYXZ(-0.017453292F * entityYRot(var2, var3), 0.017453292F * entityXRot(var2, var3), 0.0F);
         break;
      case HORIZONTAL:
         var10000 = var4.rotationYXZ(-0.017453292F * entityYRot(var2, var3), 0.017453292F * cameraXRot(var5), 0.0F);
         break;
      case VERTICAL:
         var10000 = var4.rotationYXZ(-0.017453292F * cameraYrot(var5), 0.017453292F * entityXRot(var2, var3), 0.0F);
         break;
      case CENTER:
         var10000 = var4.rotationYXZ(-0.017453292F * cameraYrot(var5), 0.017453292F * cameraXRot(var5), 0.0F);
         break;
      default:
   ...
   public static class TextDisplayRenderer extends DisplayRenderer<Display.TextDisplay, Display.TextDisplay.TextRenderState> {
      ...
      // $FF: synthetic method
      @Nullable
      protected Object getSubState(final Display param1) {
