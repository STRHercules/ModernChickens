...
public class SectionOcclusionGraph {
   ...
   public void addSectionsInFrustum(Frustum var1, List<SectionRenderDispatcher.RenderSection> var2) {
      Iterator var3 = ((SectionOcclusionGraph.GraphState)this.currentGraph.get()).storage().renderSections.iterator();

      while(var3.hasNext()) {
         SectionOcclusionGraph.Node var4 = (SectionOcclusionGraph.Node)var3.next();
   ...
   private void initializeQueueForFullUpdate(Camera var1, Queue<SectionOcclusionGraph.Node> var2) {
      ...
      if (var6 == null) {
         ...
         int var10 = Mth.floor(var4.x / 16.0D) * 16;
         int var11 = Mth.floor(var4.z / 16.0D) * 16;
         ...
         var2.add(new SectionOcclusionGraph.Node(var6, (Direction)null, 0));
      }

   }

   private void runUpdates(SectionOcclusionGraph.GraphStorage var1, Vec3 var2, Queue<SectionOcclusionGraph.Node> var3, boolean var4, Consumer<SectionRenderDispatcher.RenderSection> var5) {
      boolean var6 = true;
      BlockPos var7 = new BlockPos(Mth.floor(var2.x / 16.0D) * 16, Mth.floor(var2.y / 16.0D) * 16, Mth.floor(var2.z / 16.0D) * 16);
            ...
            if (var16 != null && (!var4 || !var9.hasDirection(var15.getOpposite()))) {
               ...
               if (var4 && var11) {
                  ...
                  label105: {
                     ...
                     do {
                        if (!(var2.subtract(var28).lengthSqr() > 3600.0D)) {
                           break label105;
                        }
