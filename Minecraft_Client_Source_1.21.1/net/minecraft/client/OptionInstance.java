...
public final class OptionInstance<T> {
   ...
   public static record Enum<T>(List<T> values, Codec<T> codec) implements OptionInstance.CycleableValueSet<T> {
      public Enum(List<T> param1, Codec<T> param2) {
         super();
         this.values = var1;
         this.codec = var2;
      }
   ...
   public static enum UnitDouble implements OptionInstance.SliderableValueSet<Double> {
      ...
      public Codec<Double> codec() {
         return Codec.withAlternative(Codec.doubleRange(0.0D, 1.0D), Codec.BOOL, (var0) -> {
            return var0 ? 1.0D : 0.0D;
         });
      }

      // $FF: synthetic method
      public Object fromSliderValue(final double param1) {
   ...
   public static record ClampingLazyMaxIntRange(int minInclusive, IntSupplier maxSupplier, int encodableMaxInclusive) implements OptionInstance.IntRangeBase, OptionInstance.SliderableOrCyclableValueSet<Integer> {
      public ClampingLazyMaxIntRange(int param1, IntSupplier param2, int param3) {
         super();
   ...
   public static record IntRange(int minInclusive, int maxInclusive, boolean applyValueImmediately) implements OptionInstance.IntRangeBase {
      ...
      public IntRange(int param1, int param2, boolean param3) {
         super();
         this.minInclusive = var1;
   ...
   interface IntRangeBase extends OptionInstance.SliderableValueSet<Integer> {
      ...
      default double toSliderValue(Integer var1) {
         if (var1 == this.minInclusive()) {
            ...
            return var1 == this.maxInclusive() ? 1.0D : Mth.map((double)var1 + 0.5D, (double)this.minInclusive(), (double)this.maxInclusive() + 1.0D, 0.0D, 1.0D);
         }
      }

      default Integer fromSliderValue(double var1) {
         if (var1 >= 1.0D) {
            var1 = 0.9999899864196777D;
         }

         return Mth.floor(Mth.map(var1, 0.0D, 1.0D, (double)this.minInclusive(), (double)this.maxInclusive() + 1.0D));
      }
      ...
      // $FF: synthetic method
      default Object fromSliderValue(double param1) {
         return this.fromSliderValue(var1);
      }
   }
   ...
   public static final class OptionInstanceSliderButton<N> extends AbstractOptionSliderButton {
      ...
      OptionInstanceSliderButton(Options var1, int var2, int var3, int var4, int var5, OptionInstance<N> var6, OptionInstance.SliderableValueSet<N> var7, OptionInstance.TooltipSupplier<N> var8, Consumer<N> var9, boolean var10) {
   ...
   public static record LazyEnum<T>(Supplier<List<T>> values, Function<T, Optional<T>> validateValue, Codec<T> codec) implements OptionInstance.CycleableValueSet<T> {
      public LazyEnum(Supplier<List<T>> param1, Function<T, Optional<T>> param2, Codec<T> param3) {
         super();
         this.values = var1;
   ...
   public static record AltEnum<T>(List<T> values, List<T> altValues, BooleanSupplier altCondition, OptionInstance.CycleableValueSet.ValueSetter<T> valueSetter, Codec<T> codec) implements OptionInstance.CycleableValueSet<T> {
      public AltEnum(List<T> param1, List<T> param2, BooleanSupplier param3, OptionInstance.CycleableValueSet.ValueSetter<T> param4, Codec<T> param5) {
         super();
         this.values = var1;
         this.altValues = var2;
   ...
   interface SliderableValueSet<T> extends OptionInstance.ValueSet<T> {
      ...
      default Function<OptionInstance<T>, AbstractWidget> createButton(OptionInstance.TooltipSupplier<T> var1, Options var2, int var3, int var4, int var5, Consumer<T> var6) {
         return (var7) -> {
            return new OptionInstance.OptionInstanceSliderButton(var2, var3, var4, var5, 20, var7, this, var1, var6, this.applyValueImmediately());
         };
      }
   }
}
