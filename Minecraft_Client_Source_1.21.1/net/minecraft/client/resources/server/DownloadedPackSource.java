   ...
   private static PackLoadFeedback createPackResponseSender(final Connection var0) {
      return new PackLoadFeedback() {
         public void reportUpdate(UUID var1, PackLoadFeedback.Update var2) {
            ...
            switch(var2) {
            case ACCEPTED:
               var10000 = ServerboundResourcePackPacket.Action.ACCEPTED;
               break;
            case DOWNLOADED:
               var10000 = ServerboundResourcePackPacket.Action.DOWNLOADED;
               break;
            default:
         ...
         public void reportFinalResult(UUID var1, PackLoadFeedback.FinalResult var2) {
            ...
            switch(var2) {
            case APPLIED:
               var10000 = ServerboundResourcePackPacket.Action.SUCCESSFULLY_LOADED;
               break;
            case DOWNLOAD_FAILED:
               var10000 = ServerboundResourcePackPacket.Action.FAILED_DOWNLOAD;
               break;
            case DECLINED:
               var10000 = ServerboundResourcePackPacket.Action.DECLINED;
               break;
            case DISCARDED:
               var10000 = ServerboundResourcePackPacket.Action.DISCARDED;
               break;
            case ACTIVATION_FAILED:
               var10000 = ServerboundResourcePackPacket.Action.FAILED_RELOAD;
               break;
            default:
               throw new MatchException((String)null, (Throwable)null);
            }
