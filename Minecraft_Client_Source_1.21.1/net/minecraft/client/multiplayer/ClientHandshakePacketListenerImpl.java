...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener {
   ...
   private void switchState(ClientHandshakePacketListenerImpl.State var1) {
      ClientHandshakePacketListenerImpl.State var2 = (ClientHandshakePacketListenerImpl.State)this.state.updateAndGet((var1x) -> {
   ...
   public void fillListenerSpecificCrashDetails(CrashReport var1, CrashReportCategory var2) {
      ...
      var2.setDetail("Login phase", () -> {
         return ((ClientHandshakePacketListenerImpl.State)this.state.get()).toString();
      });
   }
   ...
   private static enum State {
      ...
      // $FF: synthetic method
      private static ClientHandshakePacketListenerImpl.State[] $values() {
         return new ClientHandshakePacketListenerImpl.State[]{CONNECTING, AUTHORIZING, ENCRYPTING, JOINING};
      }
   }
}
