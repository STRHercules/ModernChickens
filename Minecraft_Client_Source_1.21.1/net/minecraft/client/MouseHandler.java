...
public class MouseHandler {
      ...
      if (var1 == Minecraft.getInstance().getWindow().getWindow()) {
         ...
         if (this.minecraft.getOverlay() == null) {
            if (this.minecraft.screen != null) {
               ...
               if (this.accumulatedScrollX != 0.0D && Math.signum(var10) != Math.signum(this.accumulatedScrollX)) {
                  this.accumulatedScrollX = 0.0D;
               }

               if (this.accumulatedScrollY != 0.0D && Math.signum(var12) != Math.signum(this.accumulatedScrollY)) {
   ...
   public void handleAccumulatedMovement() {
      ...
      if (this.minecraft.isWindowActive()) {
         ...
         if (var5 != null && this.minecraft.getOverlay() == null && (this.accumulatedDX != 0.0D || this.accumulatedDY != 0.0D)) {
