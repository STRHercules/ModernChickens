...
public class Gui {
   ...
   private void renderExperienceLevel(GuiGraphics var1, DeltaTracker var2) {
      ...
      if (this.isExperienceBarVisible() && var3 > 0) {
         ...
         String var4 = var3.makeConcatWithConstants<invokedynamic>(var3);
   ...
   private void renderPlayerHealth(GuiGraphics var1) {
      ...
      if (var2 != null) {
         ...
         if (var2.isEyeInFluid(FluidTags.WATER) || var20 < var19) {
            ...
            var15 -= var21 * 10;
            int var22 = Mth.ceil((double)(var20 - 2) * 10.0D / (double)var19);
            int var23 = Mth.ceil((double)var20 * 10.0D / (double)var19) - var22;
            RenderSystem.enableBlend();
