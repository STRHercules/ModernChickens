...
public class BitmapProvider implements GlyphProvider {
   ...
   private static record Glyph(float scale, NativeImage image, int offsetX, int offsetY, int width, int height, int advance, int ascent) implements GlyphInfo {
      ...
      Glyph(float param1, NativeImage param2, int param3, int param4, int param5, int param6, int param7, int param8) {
         super();
         this.scale = var1;
         this.image = var2;
         this.offsetX = var3;
   ...
   public static record Definition(ResourceLocation file, int height, int ascent, int[][] codepointGrid) implements GlyphProviderDefinition {
      ...
      public Definition(ResourceLocation param1, int param2, int param3, int[][] param4) {
         super();
         this.file = var1;
         this.height = var2;
         this.ascent = var3;
