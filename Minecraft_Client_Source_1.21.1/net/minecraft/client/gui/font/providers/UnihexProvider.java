...
public class UnihexProvider implements GlyphProvider {
   ...
   static record ByteContents(byte[] contents) implements UnihexProvider.LineData {
      private ByteContents(byte[] param1) {
         super();
         this.contents = var1;
      }
   ...
   private static record ShortContents(short[] contents) implements UnihexProvider.LineData {
      private ShortContents(short[] param1) {
         super();
         this.contents = var1;
      }
   ...
   static record IntContents(int[] contents, int bitWidth) implements UnihexProvider.LineData {
      ...
      private IntContents(int[] param1, int param2) {
         super();
         this.contents = var1;
         this.bitWidth = var2;
      }
   ...
   private static record Glyph(UnihexProvider.LineData contents, int left, int right) implements GlyphInfo {
      ...
      Glyph(UnihexProvider.LineData param1, int param2, int param3) {
         super();
         this.contents = var1;
         this.left = var2;
         this.right = var3;
   ...
   public static record Dimensions(int left, int right) {
      ...
      public Dimensions(int param1, int param2) {
         super();
         this.left = var1;
         this.right = var2;
      }
   ...
   private static record OverrideRange(int from, int to, UnihexProvider.Dimensions dimensions) {
      ...
      private OverrideRange(int param1, int param2, UnihexProvider.Dimensions param3) {
         super();
         this.from = var1;
         this.to = var2;
