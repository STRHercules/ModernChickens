...
public class GameModeSwitcherScreen extends Screen {
   ...
   protected void init() {
      ...
      for(int var1 = 0; var1 < GameModeSwitcherScreen.GameModeIcon.VALUES.length; ++var1) {
         ...
         this.slots.add(new GameModeSwitcherScreen.GameModeSlot(this, var2, this.width / 2 - ALL_SLOTS_WIDTH / 2 + var1 * 31, this.height / 2 - 31));
      }
   ...
   public class GameModeSlot extends AbstractWidget {
      ...
      public GameModeSlot(final GameModeSwitcherScreen param1, final GameModeSwitcherScreen.GameModeIcon param2, final int param3, final int param4) {
