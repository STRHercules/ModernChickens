   ...
   public class OnlineServerEntry extends ServerSelectionList.Entry {
      ...
      public void render(GuiGraphics var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10) {
         ...
         if (this.serverData.state() == ServerData.State.PINGING) {
            ...
            switch(var12) {
            case 1:
               var19 = ServerSelectionList.PINGING_2_SPRITE;
               break;
            case 2:
               var19 = ServerSelectionList.PINGING_3_SPRITE;
               break;
            case 3:
               var19 = ServerSelectionList.PINGING_4_SPRITE;
               break;
            case 4:
               var19 = ServerSelectionList.PINGING_5_SPRITE;
               break;
            default:
               var19 = ServerSelectionList.PINGING_1_SPRITE;
            }
