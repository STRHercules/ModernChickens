...
public class OverlayRecipeComponent implements Renderable, GuiEventListener {
   ...
   public void init(Minecraft var1, RecipeCollection var2, int var3, int var4, int var5, int var6, float var7) {
      ...
      for(int var21 = 0; var21 < var12; ++var21) {
         ...
         if (this.isFurnaceMenu) {
            this.recipeButtons.add(new OverlayRecipeComponent.OverlaySmeltingRecipeButton(this, var24, var25, var23, var22));
         } else {
   ...
   class OverlaySmeltingRecipeButton extends OverlayRecipeComponent.OverlayRecipeButton {
      public OverlaySmeltingRecipeButton(final OverlayRecipeComponent param1, final int param2, final int param3, final RecipeHolder param4, final boolean param5) {
   ...
   private class OverlayRecipeButton extends AbstractWidget implements PlaceRecipe<Ingredient> {
      ...
      public void addItemToSlot(Ingredient var1, int var2, int var3, int var4, int var5) {
         ...
         if (var6.length != 0) {
            this.ingredientPos.add(new OverlayRecipeComponent.OverlayRecipeButton.Pos(this, 3 + var4 * 7, 3 + var5 * 7, var6));
         }
      ...
      public void renderWidget(GuiGraphics var1, int var2, int var3, float var4) {
         ...
         for(Iterator var6 = this.ingredientPos.iterator(); var6.hasNext(); var1.pose().popPose()) {
            ...
            var1.pose().pushPose();
            var1.pose().translate((double)var7.x, (double)var7.y, 0.0D);
      ...
      protected class Pos {
         ...
         public Pos(final OverlayRecipeComponent.OverlayRecipeButton param1, final int param2, final int param3, final ItemStack[] param4) {
            super();
            this.x = var2;
            this.y = var3;
