...
public interface ClientTooltipComponent {
   ...
   static ClientTooltipComponent create(TooltipComponent var0) {
      if (var0 instanceof BundleTooltip) {
         BundleTooltip var1 = (BundleTooltip)var0;
         return new ClientBundleTooltip(var1.contents());
      } else if (var0 instanceof ClientActivePlayersTooltip.ActivePlayersTooltip) {
         ClientActivePlayersTooltip.ActivePlayersTooltip var2 = (ClientActivePlayersTooltip.ActivePlayersTooltip)var0;
