...
enum AdvancementTabType {
   ...
   private AdvancementTabType(final AdvancementTabType.Sprites param3, final AdvancementTabType.Sprites param4, final int param5, final int param6, final int param7) {
   ...
   private static record Sprites(ResourceLocation first, ResourceLocation middle, ResourceLocation last) {
      Sprites(ResourceLocation param1, ResourceLocation param2, ResourceLocation param3) {
         super();
         this.first = var1;
         this.middle = var2;
         this.last = var3;
