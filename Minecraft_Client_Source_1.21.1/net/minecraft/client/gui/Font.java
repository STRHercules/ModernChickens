...
public class Font {
   ...
   private class StringRenderOutput implements FormattedCharSink {
      ...
      public StringRenderOutput(final MultiBufferSource param2, final float param3, final float param4, final int param5, final boolean param6, final Matrix4f param7, final Font.DisplayMode param8, final int param9) {
         super();
