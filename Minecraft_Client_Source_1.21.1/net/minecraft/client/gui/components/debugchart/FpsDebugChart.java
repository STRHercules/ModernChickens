...
public class FpsDebugChart extends AbstractDebugChart {
   ...
   protected void renderAdditionalLinesAndLabels(GuiGraphics var1, int var2, int var3, int var4) {
      ...
      if (var5 > 0 && var5 <= 250) {
         var1.hLine(RenderType.guiOverlay(), var2, var2 + var3 - 1, var4 - this.getSampleHeight(1.0E9D / (double)var5) - 1, -16711681);
      }
   ...
   protected int getSampleHeight(double var1) {
      return (int)Math.round(toMilliseconds(var1) * 60.0D / 33.333333333333336D);
   }

   protected int getSampleColor(long var1) {
      return this.getSampleColor(toMilliseconds((double)var1), 0.0D, -16711936, 28.0D, -256, 56.0D, -65536);
   }
