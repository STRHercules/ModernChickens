...
public class TpsDebugChart extends AbstractDebugChart {
   ...
   protected int getSampleHeight(double var1) {
      return (int)Math.round(toMilliseconds(var1) * 60.0D / (double)(Float)this.msptSupplier.get());
   }

   protected int getSampleColor(long var1) {
      float var3 = (Float)this.msptSupplier.get();
      return this.getSampleColor(toMilliseconds((double)var1), (double)var3, -16711936, (double)var3 * 1.125D, -256, (double)var3 * 1.25D, -65536);
   }
