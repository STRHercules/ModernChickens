...
public class PopupScreen extends Screen {
   ...
   PopupScreen(Screen var1, int var2, @Nullable ResourceLocation var3, Component var4, Component var5, List<PopupScreen.ButtonOption> var6, @Nullable Runnable var7) {
      super(var4);
   ...
   private LinearLayout buildButtonRow() {
      ...
      while(var4.hasNext()) {
         PopupScreen.ButtonOption var5 = (PopupScreen.ButtonOption)var4.next();
   ...
   static record ButtonOption(Component message, Consumer<PopupScreen> action) {
      ButtonOption(Component param1, Consumer<PopupScreen> param2) {
         super();
         this.message = var1;
         this.action = var2;
      }
