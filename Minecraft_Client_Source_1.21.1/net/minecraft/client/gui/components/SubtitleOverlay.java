...
public class SubtitleOverlay implements SoundEventListener {
   ...
   public void render(GuiGraphics var1) {
      ...
      if (this.isListening) {
         ...
         if (!this.audibleSubtitles.isEmpty()) {
            ...
            SubtitleOverlay.Subtitle var12;
            while(var11.hasNext()) {
               var12 = (SubtitleOverlay.Subtitle)var11.next();
               var12.purgeOldInstances(3000.0D * var9);
            ...
            while(var11.hasNext()) {
               ...
               if (var15 != null) {
                  ...
                  int var27 = Mth.floor(Mth.clampedLerp(255.0F, 75.0F, (float)(Util.getMillis() - var15.time) / (float)(3000.0D * var9)));
   ...
   public void onPlaySound(SoundInstance var1, WeighedSoundEvents var2, float var3) {
      if (var2.getSubtitle() != null) {
         ...
         if (!this.subtitles.isEmpty()) {
            ...
            while(var5.hasNext()) {
               SubtitleOverlay.Subtitle var6 = (SubtitleOverlay.Subtitle)var5.next();
   ...
   static class Subtitle {
      ...
      public SubtitleOverlay.SoundPlayedAt getClosest(Vec3 var1) {
         if (this.playedAt.isEmpty()) {
            ...
            return this.playedAt.size() == 1 ? (SubtitleOverlay.SoundPlayedAt)this.playedAt.getFirst() : (SubtitleOverlay.SoundPlayedAt)this.playedAt.stream().min(Comparator.comparingDouble((var1x) -> {
   ...
   static record SoundPlayedAt(Vec3 location, long time) {
      ...
      SoundPlayedAt(Vec3 param1, long param2) {
         super();
         this.location = var1;
         this.time = var2;
      }
