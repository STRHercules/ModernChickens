...
public class PlayerTabOverlay {
   ...
   public void render(GuiGraphics var1, int var2, Scoreboard var3, @Nullable Objective var4) {
      ...
      int var15;
      for(Iterator var10 = var5.iterator(); var10.hasNext(); var6.add(new PlayerTabOverlay.ScoreDisplayEntry(var12, var13, var14, var15))) {
      ...
      for(int var45 = 0; var45 < var34; ++var45) {
         ...
         if (var45 < var5.size()) {
            ...
            PlayerTabOverlay.ScoreDisplayEntry var28 = (PlayerTabOverlay.ScoreDisplayEntry)var6.get(var45);
   ...
   private static record ScoreDisplayEntry(Component name, int score, @Nullable Component formattedScore, int scoreWidth) {
      ...
      ScoreDisplayEntry(Component param1, int param2, @Nullable Component param3, int param4) {
         super();
         this.name = var1;
         this.score = var2;
