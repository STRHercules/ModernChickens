...
public class RecipeToast implements Toast {
   ...
   public Toast.Visibility render(GuiGraphics var1, ToastComponent var2, long var3) {
      ...
      if (this.recipes.isEmpty()) {
         ...
         RecipeHolder var5 = (RecipeHolder)this.recipes.get((int)((double)var3 / Math.max(1.0D, 5000.0D * var2.getNotificationDisplayTimeMultiplier() / (double)this.recipes.size()) % (double)this.recipes.size()));
