...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>> extends AbstractContainerWidget {
   ...
   protected final E getEntryAtPosition(double var1, double var3) {
      ...
      return var1 >= (double)var7 && var1 <= (double)var8 && var10 >= 0 && var9 >= 0 && var10 < this.getItemCount() ? (AbstractSelectionList.Entry)this.children().get(var10) : null;
   }
   ...
   public boolean mouseScrolled(double var1, double var3, double var5, double var7) {
      this.setScrollAmount(this.getScrollAmount() - var7 * (double)this.itemHeight / 2.0D);
      return true;
   }
