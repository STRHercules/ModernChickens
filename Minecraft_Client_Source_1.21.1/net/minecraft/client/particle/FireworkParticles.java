...
public class FireworkParticles {
   ...
   public static class SparkProvider implements ParticleProvider<SimpleParticleType> {
      ...
      // $FF: synthetic method
      public Particle createParticle(final ParticleOptions param1, final ClientLevel param2, final double param3, final double param5, final double param7, final double param9, final double param11, final double param13) {
   ...
   public static class Starter extends NoRenderParticle {
      ...
      public void tick() {
         ...
         if (this.life % 2 == 0 && this.life / 2 < this.explosions.size()) {
            ...
            switch(var10.shape()) {
            case SMALL_BALL:
               this.createParticleBall(0.25D, 2, var5, var6, var13, var14);
               break;
            case LARGE_BALL:
               this.createParticleBall(0.5D, 4, var5, var6, var13, var14);
               break;
            case STAR:
               this.createParticleShape(0.5D, STAR_PARTICLE_COORDS, var5, var6, var13, var14, false);
               break;
            case CREEPER:
               this.createParticleShape(0.5D, CREEPER_PARTICLE_COORDS, var5, var6, var13, var14, true);
               break;
            case BURST:
               this.createParticleBurst(var5, var6, var13, var14);
            }

            int var7 = var5.getInt(0);
            Particle var8 = this.engine.createParticle(ParticleTypes.FLASH, this.x, this.y, this.z, 0.0D, 0.0D, 0.0D);
