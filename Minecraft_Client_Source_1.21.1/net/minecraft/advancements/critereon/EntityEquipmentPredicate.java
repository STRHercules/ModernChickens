...
public record EntityEquipmentPredicate(Optional<ItemPredicate> head, Optional<ItemPredicate> chest, Optional<ItemPredicate> legs, Optional<ItemPredicate> feet, Optional<ItemPredicate> body, Optional<ItemPredicate> mainhand, Optional<ItemPredicate> offhand) {
   ...
   public EntityEquipmentPredicate(Optional<ItemPredicate> param1, Optional<ItemPredicate> param2, Optional<ItemPredicate> param3, Optional<ItemPredicate> param4, Optional<ItemPredicate> param5, Optional<ItemPredicate> param6, Optional<ItemPredicate> param7) {
      super();
      this.head = var1;
      this.chest = var2;
      this.legs = var3;
