...
public interface MinMaxBounds<T extends Number> {
   ...
   static <T extends Number, R extends MinMaxBounds<T>> Codec<R> createCodec(Codec<T> var0, MinMaxBounds.BoundsFactory<T, R> var1) {
      Codec var2 = RecordCodecBuilder.create((var2x) -> {
         P2 var10000 = var2x.group(var0.optionalFieldOf("min").forGetter(MinMaxBounds::min), var0.optionalFieldOf("max").forGetter(MinMaxBounds::max));
   ...
   static <T extends Number, R extends MinMaxBounds<T>> R fromReader(StringReader var0, MinMaxBounds.BoundsFromReaderFactory<T, R> var1, Function<String, T> var2, Supplier<DynamicCommandExceptionType> var3, Function<T, T> var4) throws CommandSyntaxException {
      if (!var0.canRead()) {
   ...
   public static record Doubles(Optional<Double> min, Optional<Double> max, Optional<Double> minSq, Optional<Double> maxSq) implements MinMaxBounds<Double> {
      ...
      public Doubles(Optional<Double> param1, Optional<Double> param2, Optional<Double> param3, Optional<Double> param4) {
         super();
         this.min = var1;
         this.max = var2;
         this.minSq = var3;
      ...
      public static MinMaxBounds.Doubles fromReader(StringReader var0, Function<Double, Double> var1) throws CommandSyntaxException {
         ...
         return (MinMaxBounds.Doubles)MinMaxBounds.fromReader(var0, var10001, var10002, var10003::readerInvalidDouble, var1);
      }
      ...
      static {
         CODEC = MinMaxBounds.createCodec(Codec.DOUBLE, MinMaxBounds.Doubles::new);
      }
   }
   ...
   public static record Ints(Optional<Integer> min, Optional<Integer> max, Optional<Long> minSq, Optional<Long> maxSq) implements MinMaxBounds<Integer> {
      ...
      public Ints(Optional<Integer> param1, Optional<Integer> param2, Optional<Long> param3, Optional<Long> param4) {
         super();
         this.min = var1;
         this.max = var2;
         this.minSq = var3;
      ...
      public static MinMaxBounds.Ints fromReader(StringReader var0, Function<Integer, Integer> var1) throws CommandSyntaxException {
         ...
         BuiltInExceptionProvider var10003 = CommandSyntaxException.BUILT_IN_EXCEPTIONS;
         Objects.requireNonNull(var10003);
         return (MinMaxBounds.Ints)MinMaxBounds.fromReader(var0, var10001, var10002, var10003::readerInvalidInt, var1);
      }
      ...
      static {
         CODEC = MinMaxBounds.createCodec(Codec.INT, MinMaxBounds.Ints::new);
      }
   }
}
