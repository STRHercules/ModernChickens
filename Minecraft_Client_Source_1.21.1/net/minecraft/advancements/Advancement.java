...
public record Advancement(Optional<ResourceLocation> parent, Optional<DisplayInfo> display, AdvancementRewards rewards, Map<String, Criterion<?>> criteria, AdvancementRequirements requirements, boolean sendsTelemetryEvent, Optional<Component> name) {
   ...
   public Advancement(Optional<ResourceLocation> param1, Optional<DisplayInfo> param2, AdvancementRewards param3, Map<String, Criterion<?>> param4, AdvancementRequirements param5, boolean param6, Optional<Component> param7) {
      super();
      this.parent = var1;
      this.display = var2;
      this.rewards = var3;
   ...
   public static class Builder {
      ...
      public Advancement.Builder display(ItemStack var1, Component var2, Component var3, @Nullable ResourceLocation var4, AdvancementType var5, boolean var6, boolean var7, boolean var8) {
         return this.display(new DisplayInfo(var1, var2, var3, Optional.ofNullable(var4), var5, var6, var7, var8));
      }

      public Advancement.Builder display(ItemLike var1, Component var2, Component var3, @Nullable ResourceLocation var4, AdvancementType var5, boolean var6, boolean var7, boolean var8) {
