...
public class ExperienceCommand {
   ...
   private static enum Type {
      ...
      private Type(final String param3, final BiConsumer<ServerPlayer, Integer> param4, final BiPredicate<ServerPlayer, Integer> param5, final ToIntFunction<ServerPlayer> param6) {
         this.add = var4;
         this.name = var3;
         this.set = var5;
         this.query = var6;
