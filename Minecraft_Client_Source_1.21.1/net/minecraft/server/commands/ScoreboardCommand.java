...
public class ScoreboardCommand {
   ...
   private static ArgumentBuilder<CommandSourceStack, ?> addNumberFormats(CommandBuildContext var0, ArgumentBuilder<CommandSourceStack, ?> var1, ScoreboardCommand.NumberFormatCommandExecutor var2) {
      ...
      while(true) {
         ...
         label32: {
            ...
            do {
               ...
               var10 = var4.getPlayerScoreInfo(var9, var6);
   ...
   private static int addObjective(CommandSourceStack var0, String var1, ObjectiveCriteria var2, Component var3) throws CommandSyntaxException {
      ...
      if (var4.getObjective(var1) != null) {
         ...
         var4.addObjective(var1, var2, var3, var2.getDefaultRenderType(), false, (NumberFormat)null);
