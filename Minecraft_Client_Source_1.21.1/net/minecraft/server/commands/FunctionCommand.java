...
public class FunctionCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      ...
      while(var2.hasNext()) {
         ...
         var3.wrap(var1, (var1x) -> {
            return var1x.executes(new FunctionCommand.FunctionCustomExecutor() {
      ...
      })).then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("name", FunctionArgument.functions()).suggests(SUGGEST_FUNCTION).executes(new FunctionCommand.FunctionCustomExecutor() {
         @Nullable
   ...
   public static <T extends ExecutionCommandSource<T>> void queueFunctions(Collection<CommandFunction<T>> var0, @Nullable CompoundTag var1, T var2, T var3, ExecutionControl<T> var4, FunctionCommand.Callbacks<T> var5, ChainModifiers var6) throws CommandSyntaxException {
      if (var6.isReturn()) {
   ...
   private static <T extends ExecutionCommandSource<T>> CommandResultCallback decorateOutputIfNeeded(T var0, FunctionCommand.Callbacks<T> var1, ResourceLocation var2, CommandResultCallback var3) {
   ...
   private static <T extends ExecutionCommandSource<T>> void queueFunctionsAsReturn(Collection<CommandFunction<T>> var0, @Nullable CompoundTag var1, T var2, T var3, ExecutionControl<T> var4, FunctionCommand.Callbacks<T> var5) throws CommandSyntaxException {
   ...
   private static <T extends ExecutionCommandSource<T>> void queueFunctionsNoReturn(Collection<CommandFunction<T>> var0, @Nullable CompoundTag var1, T var2, T var3, ExecutionControl<T> var4, FunctionCommand.Callbacks<T> var5) throws CommandSyntaxException {
      CommandDispatcher var6 = var2.dispatcher();
      ExecutionCommandSource var7 = var3.clearCallbacks();
   ...
   abstract static class FunctionCustomExecutor extends CustomCommandExecutor.WithErrorHandling<CommandSourceStack> implements CustomCommandExecutor.CommandAdapter<CommandSourceStack> {
      ...
      // $FF: synthetic method
      public void runGuarded(final ExecutionCommandSource param1, final ContextChain param2, final ChainModifiers param3, final ExecutionControl param4) throws CommandSyntaxException {
