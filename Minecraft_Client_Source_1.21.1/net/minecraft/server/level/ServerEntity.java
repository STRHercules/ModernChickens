...
public class ServerEntity {
   ...
   public void sendChanges() {
      ...
      if (this.tickCount % this.updateInterval == 0 || this.entity.hasImpulse || this.entity.getEntityData().isDirty()) {
         ...
         if (this.entity.isPassenger()) {
            ...
            boolean var28 = this.positionCodec.delta(var26).lengthSqr() >= 7.62939453125E-6D;
            Object var29 = null;
            ...
            if ((this.trackDelta || this.entity.hasImpulse || this.entity instanceof LivingEntity && ((LivingEntity)this.entity).isFallFlying()) && this.tickCount > 0) {
               ...
               if (var19 > 1.0E-7D || var19 > 0.0D && var18.lengthSqr() == 0.0D) {
   ...
   public void sendPairingData(ServerPlayer var1, Consumer<Packet<ClientGamePacketListener>> var2) {
      ...
      if (var13 instanceof Leashable) {
         Leashable var12 = (Leashable)var13;
         if (var12.isLeashed()) {
