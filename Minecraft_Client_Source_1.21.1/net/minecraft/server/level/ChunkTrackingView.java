...
public interface ChunkTrackingView {
   ...
   static void difference(ChunkTrackingView var0, ChunkTrackingView var1, Consumer<ChunkPos> var2, Consumer<ChunkPos> var3) {
      if (!var0.equals(var1)) {
         if (var0 instanceof ChunkTrackingView.Positioned) {
            ChunkTrackingView.Positioned var4 = (ChunkTrackingView.Positioned)var0;
            if (var1 instanceof ChunkTrackingView.Positioned) {
               ChunkTrackingView.Positioned var5 = (ChunkTrackingView.Positioned)var1;
   ...
   public static record Positioned(ChunkPos center, int viewDistance) implements ChunkTrackingView {
      public Positioned(ChunkPos param1, int param2) {
         super();
         this.center = var1;
