...
public class ItemPredicateArgument implements ArgumentType<ItemPredicateArgument.Result> {
   ...
   static final Map<ResourceLocation, ItemPredicateArgument.ComponentWrapper> PSEUDO_COMPONENTS;
   static final Map<ResourceLocation, ItemPredicateArgument.PredicateWrapper> PSEUDO_PREDICATES;
   ...
   private static class Context implements ComponentPredicateParser.Context<Predicate<ItemStack>, ItemPredicateArgument.ComponentWrapper, ItemPredicateArgument.PredicateWrapper> {
      ...
      public ItemPredicateArgument.PredicateWrapper lookupPredicateType(ImmutableStringReader var1, ResourceLocation var2) throws CommandSyntaxException {
         ...
         return var3 != null ? var3 : (ItemPredicateArgument.PredicateWrapper)this.predicates.get(ResourceKey.create(Registries.ITEM_SUB_PREDICATE_TYPE, var2)).map(ItemPredicateArgument.PredicateWrapper::new).orElseThrow(() -> {
      ...
      // $FF: synthetic method
      public Object createPredicateTest(final ImmutableStringReader param1, final Object param2, final Tag param3) throws CommandSyntaxException {
         return this.createPredicateTest(var1, (ItemPredicateArgument.PredicateWrapper)var2, var3);
      }

      // $FF: synthetic method
      public Object lookupPredicateType(final ImmutableStringReader param1, final ResourceLocation param2) throws CommandSyntaxException {
         return this.lookupPredicateType(var1, var2);
      }

      // $FF: synthetic method
      public Object lookupComponentType(final ImmutableStringReader param1, final ResourceLocation param2) throws CommandSyntaxException {
         return this.lookupComponentType(var1, var2);
      }

      // $FF: synthetic method
      public Object forTagType(final ImmutableStringReader param1, final ResourceLocation param2) throws CommandSyntaxException {
         return this.forTagType(var1, var2);
      }

      // $FF: synthetic method
      public Object forElementType(final ImmutableStringReader param1, final ResourceLocation param2) throws CommandSyntaxException {
   ...
   private static record ComponentWrapper(ResourceLocation id, Predicate<ItemStack> presenceChecker, Decoder<? extends Predicate<ItemStack>> valueChecker) {
      ...
      ComponentWrapper(ResourceLocation param1, Predicate<ItemStack> param2, Decoder<? extends Predicate<ItemStack>> param3) {
         super();
         this.id = var1;
   ...
   static record PredicateWrapper(ResourceLocation id, Decoder<? extends Predicate<ItemStack>> type) {
      ...
      PredicateWrapper(ResourceLocation param1, Decoder<? extends Predicate<ItemStack>> param2) {
         super();
         this.id = var1;
         this.type = var2;
      }
