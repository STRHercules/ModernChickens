...
public class FriendlyByteBuf extends ByteBuf {
   ...
   // $FF: synthetic method
   public ByteBuf touch(final Object param1) {
   ...
   // $FF: synthetic method
   public ByteBuf retain(final int param1) {
      return this.retain(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeZero(final int param1) {
      return this.writeZero(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeBytes(final ByteBuffer param1) {
      return this.writeBytes(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeBytes(final byte[] param1, final int param2, final int param3) {
      return this.writeBytes(var1, var2, var3);
   }

   // $FF: synthetic method
   public ByteBuf writeBytes(final byte[] param1) {
      return this.writeBytes(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeBytes(final ByteBuf param1, final int param2, final int param3) {
      return this.writeBytes(var1, var2, var3);
   }

   // $FF: synthetic method
   public ByteBuf writeBytes(final ByteBuf param1, final int param2) {
      return this.writeBytes(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf writeBytes(final ByteBuf param1) {
      return this.writeBytes(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeDouble(final double param1) {
      return this.writeDouble(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeFloat(final float param1) {
      return this.writeFloat(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeChar(final int param1) {
      return this.writeChar(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeLongLE(final long param1) {
      return this.writeLongLE(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeLong(final long param1) {
      return this.writeLong(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeIntLE(final int param1) {
      return this.writeIntLE(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeInt(final int param1) {
      return this.writeInt(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeMediumLE(final int param1) {
      return this.writeMediumLE(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeMedium(final int param1) {
      return this.writeMedium(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeShortLE(final int param1) {
      return this.writeShortLE(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeShort(final int param1) {
      return this.writeShort(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeByte(final int param1) {
      return this.writeByte(var1);
   }

   // $FF: synthetic method
   public ByteBuf writeBoolean(final boolean param1) {
      return this.writeBoolean(var1);
   }

   // $FF: synthetic method
   public ByteBuf skipBytes(final int param1) {
      return this.skipBytes(var1);
   }

   // $FF: synthetic method
   public ByteBuf readBytes(final OutputStream param1, final int param2) throws IOException {
      return this.readBytes(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf readBytes(final ByteBuffer param1) {
      return this.readBytes(var1);
   }

   // $FF: synthetic method
   public ByteBuf readBytes(final byte[] param1, final int param2, final int param3) {
      return this.readBytes(var1, var2, var3);
   }

   // $FF: synthetic method
   public ByteBuf readBytes(final byte[] param1) {
      return this.readBytes(var1);
   }

   // $FF: synthetic method
   public ByteBuf readBytes(final ByteBuf param1, final int param2, final int param3) {
      return this.readBytes(var1, var2, var3);
   }

   // $FF: synthetic method
   public ByteBuf readBytes(final ByteBuf param1, final int param2) {
      return this.readBytes(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf readBytes(final ByteBuf param1) {
      return this.readBytes(var1);
   }

   // $FF: synthetic method
   public ByteBuf setZero(final int param1, final int param2) {
      return this.setZero(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setBytes(final int param1, final ByteBuffer param2) {
      return this.setBytes(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setBytes(final int param1, final byte[] param2, final int param3, final int param4) {
      return this.setBytes(var1, var2, var3, var4);
   }

   // $FF: synthetic method
   public ByteBuf setBytes(final int param1, final byte[] param2) {
      return this.setBytes(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setBytes(final int param1, final ByteBuf param2, final int param3, final int param4) {
      return this.setBytes(var1, var2, var3, var4);
   }

   // $FF: synthetic method
   public ByteBuf setBytes(final int param1, final ByteBuf param2, final int param3) {
      return this.setBytes(var1, var2, var3);
   }

   // $FF: synthetic method
   public ByteBuf setBytes(final int param1, final ByteBuf param2) {
      return this.setBytes(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setDouble(final int param1, final double param2) {
      return this.setDouble(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setFloat(final int param1, final float param2) {
      return this.setFloat(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setChar(final int param1, final int param2) {
      return this.setChar(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setLongLE(final int param1, final long param2) {
      return this.setLongLE(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setLong(final int param1, final long param2) {
      return this.setLong(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setIntLE(final int param1, final int param2) {
      return this.setIntLE(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setInt(final int param1, final int param2) {
      return this.setInt(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setMediumLE(final int param1, final int param2) {
      return this.setMediumLE(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setMedium(final int param1, final int param2) {
      return this.setMedium(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setShortLE(final int param1, final int param2) {
      return this.setShortLE(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setShort(final int param1, final int param2) {
      return this.setShort(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setByte(final int param1, final int param2) {
      return this.setByte(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf setBoolean(final int param1, final boolean param2) {
      return this.setBoolean(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf getBytes(final int param1, final OutputStream param2, final int param3) throws IOException {
      return this.getBytes(var1, var2, var3);
   }

   // $FF: synthetic method
   public ByteBuf getBytes(final int param1, final ByteBuffer param2) {
      return this.getBytes(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf getBytes(final int param1, final byte[] param2, final int param3, final int param4) {
      return this.getBytes(var1, var2, var3, var4);
   }

   // $FF: synthetic method
   public ByteBuf getBytes(final int param1, final byte[] param2) {
      return this.getBytes(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf getBytes(final int param1, final ByteBuf param2, final int param3, final int param4) {
      return this.getBytes(var1, var2, var3, var4);
   }

   // $FF: synthetic method
   public ByteBuf getBytes(final int param1, final ByteBuf param2, final int param3) {
      return this.getBytes(var1, var2, var3);
   }

   // $FF: synthetic method
   public ByteBuf getBytes(final int param1, final ByteBuf param2) {
      return this.getBytes(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf ensureWritable(final int param1) {
   ...
   // $FF: synthetic method
   public ByteBuf setIndex(final int param1, final int param2) {
      return this.setIndex(var1, var2);
   }

   // $FF: synthetic method
   public ByteBuf writerIndex(final int param1) {
      return this.writerIndex(var1);
   }

   // $FF: synthetic method
   public ByteBuf readerIndex(final int param1) {
      return this.readerIndex(var1);
   }

   // $FF: synthetic method
   public ByteBuf capacity(final int param1) {
