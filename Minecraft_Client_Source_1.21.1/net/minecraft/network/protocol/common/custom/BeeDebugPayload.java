...
public record BeeDebugPayload(BeeDebugPayload.BeeInfo beeInfo) implements CustomPacketPayload {
   ...
   public BeeDebugPayload(BeeDebugPayload.BeeInfo param1) {
      super();
      this.beeInfo = var1;
   }
   ...
   public static record BeeInfo(UUID uuid, int id, Vec3 pos, @Nullable Path path, @Nullable BlockPos hivePos, @Nullable BlockPos flowerPos, int travelTicks, Set<String> goals, List<BlockPos> blacklistedHives) {
      ...
      public BeeInfo(UUID param1, int param2, Vec3 param3, @Nullable Path param4, @Nullable BlockPos param5, @Nullable BlockPos param6, int param7, Set<String> param8, List<BlockPos> param9) {
         super();
         this.uuid = var1;
         this.id = var2;
         this.pos = var3;
