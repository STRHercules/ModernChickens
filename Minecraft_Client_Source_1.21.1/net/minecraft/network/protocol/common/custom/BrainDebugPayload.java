...
public record BrainDebugPayload(BrainDebugPayload.BrainDump brainDump) implements CustomPacketPayload {
   ...
   public BrainDebugPayload(BrainDebugPayload.BrainDump param1) {
      super();
      this.brainDump = var1;
   }
   ...
   public static record BrainDump(UUID uuid, int id, String name, String profession, int xp, float health, float maxHealth, Vec3 pos, String inventory, @Nullable Path path, boolean wantsGolem, int angerLevel, List<String> activities, List<String> behaviors, List<String> memories, List<String> gossips, Set<BlockPos> pois, Set<BlockPos> potentialPois) {
      ...
      public BrainDump(UUID param1, int param2, String param3, String param4, int param5, float param6, float param7, Vec3 param8, String param9, @Nullable Path param10, boolean param11, int param12, List<String> param13, List<String> param14, List<String> param15, List<String> param16, Set<BlockPos> param17, Set<BlockPos> param18) {
         super();
         this.uuid = var1;
         this.id = var2;
         this.name = var3;
