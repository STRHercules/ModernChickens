...
public record PlayerChatMessage(SignedMessageLink link, @Nullable MessageSignature signature, SignedMessageBody signedBody, @Nullable Component unsignedContent, FilterMask filterMask) {
   ...
   public PlayerChatMessage(SignedMessageLink param1, @Nullable MessageSignature param2, SignedMessageBody param3, @Nullable Component param4, FilterMask param5) {
      super();
      this.link = var1;
      this.signature = var2;
