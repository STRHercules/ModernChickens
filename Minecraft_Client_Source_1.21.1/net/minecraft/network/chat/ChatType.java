...
public record ChatType(ChatTypeDecoration chat, ChatTypeDecoration narration) {
   ...
   public ChatType(ChatTypeDecoration param1, ChatTypeDecoration param2) {
      super();
      this.chat = var1;
      this.narration = var2;
   }
   ...
   public static record Bound(Holder<ChatType> chatType, Component name, Optional<Component> targetName) {
      public static final StreamCodec<RegistryFriendlyByteBuf, ChatType.Bound> STREAM_CODEC;

      Bound(Holder<ChatType> var1, Component var2) {
         this(var1, var2, Optional.empty());
      }

      public Bound(Holder<ChatType> param1, Component param2, Optional<Component> param3) {
         super();
         this.chatType = var1;
         this.name = var2;
      ...
      static {
         STREAM_CODEC = StreamCodec.composite(ChatType.STREAM_CODEC, ChatType.Bound::chatType, ComponentSerialization.TRUSTED_STREAM_CODEC, ChatType.Bound::name, ComponentSerialization.TRUSTED_OPTIONAL_STREAM_CODEC, ChatType.Bound::targetName, ChatType.Bound::new);
      }
   }
}
