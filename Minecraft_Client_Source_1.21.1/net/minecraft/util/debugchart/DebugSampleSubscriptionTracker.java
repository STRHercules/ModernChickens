...
public class DebugSampleSubscriptionTracker {
   ...
   private void handleSubscriptions(long var1, int var3) {
      ...
      while(var4.hasNext()) {
         DebugSampleSubscriptionTracker.SubscriptionRequest var5 = (DebugSampleSubscriptionTracker.SubscriptionRequest)var4.next();
         ((Map)this.subscriptions.get(var5.sampleType())).put(var5.player(), new DebugSampleSubscriptionTracker.SubscriptionStartedAt(var1, var3));
      }
   ...
   private void handleUnsubscriptions(long var1, int var3) {
      ...
      while(var4.hasNext()) {
         ...
         var5.entrySet().removeIf((var4x) -> {
            ...
            DebugSampleSubscriptionTracker.SubscriptionStartedAt var6 = (DebugSampleSubscriptionTracker.SubscriptionStartedAt)var4x.getValue();
   ...
   static record SubscriptionRequest(ServerPlayer player, RemoteDebugSampleType sampleType) {
      SubscriptionRequest(ServerPlayer param1, RemoteDebugSampleType param2) {
         super();
         this.player = var1;
   ...
   static record SubscriptionStartedAt(long millis, int tick) {
      SubscriptionStartedAt(long param1, int param3) {
         super();
         this.millis = var1;
         this.tick = var3;
      }
