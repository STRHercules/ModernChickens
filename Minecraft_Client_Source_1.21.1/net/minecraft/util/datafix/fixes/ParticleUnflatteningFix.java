...
public class ParticleUnflatteningFix extends DataFix {
   ...
   private <T> Dynamic<T> fix(Dynamic<T> var1) {
      ...
      if (var2.isEmpty()) {
         ...
         case -2042272551:
            if (var5.equals("minecraft:block_marker")) {
               var8 = 2;
            }
            break;
         case -1401801828:
            if (var5.equals("minecraft:sculk_charge")) {
               var8 = 7;
            }
            break;
         case -1371459830:
            if (var5.equals("minecraft:dust_pillar")) {
               var8 = 4;
            }
            break;
         case -1149887360:
            if (var5.equals("minecraft:block")) {
               var8 = 1;
            }
            break;
         case -1006856097:
            if (var5.equals("minecraft:dust")) {
               var8 = 5;
            }
            break;
         case -1006708544:
            if (var5.equals("minecraft:item")) {
               var8 = 0;
            }
            break;
         case -803673249:
            if (var5.equals("minecraft:shriek")) {
               var8 = 9;
            }
            break;
         case -669022697:
            if (var5.equals("minecraft:falling_dust")) {
               var8 = 3;
            }
            break;
         case -535503983:
            if (var5.equals("minecraft:dust_color_transition")) {
               var8 = 6;
            }
            break;
         case 1767512325:
            if (var5.equals("minecraft:vibration")) {
               var8 = 8;
            }
         }
