...
public class HashCache {
   ...
   public CompletableFuture<HashCache.UpdateResult> generateUpdate(String var1, HashCache.UpdateFunction var2) {
      ...
      if (var3 == null) {
         ...
         HashCache.CacheUpdater var4 = new HashCache.CacheUpdater(this, var1, this.versionId, var3);
   ...
   static record ProviderCache(String version, ImmutableMap<Path, HashCode> data) {
      ...
      ProviderCache(String param1, ImmutableMap<Path, HashCode> param2) {
         super();
         this.version = var1;
         this.data = var2;
      }
   ...
   class CacheUpdater implements CachedOutput {
      ...
      CacheUpdater(final HashCache param1, final String param2, final String param3, final HashCache.ProviderCache param4) {
         super();
         this.provider = var2;
         this.oldCache = var4;
   ...
   public static record UpdateResult(String providerId, HashCache.ProviderCache cache, int writes) {
      public UpdateResult(String param1, HashCache.ProviderCache param2, int param3) {
         super();
   ...
   static record ProviderCacheBuilder(String version, ConcurrentMap<Path, HashCode> data) {
      ...
      private ProviderCacheBuilder(String param1, ConcurrentMap<Path, HashCode> param2) {
         super();
         this.version = var1;
         this.data = var2;
      }
