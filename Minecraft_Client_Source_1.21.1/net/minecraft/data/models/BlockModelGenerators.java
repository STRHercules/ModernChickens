...
public class BlockModelGenerators {
   ...
   private void createVault() {
      ...
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(var1).with(createHorizontalFacingDispatch()).with(PropertyDispatch.properties(VaultBlock.STATE, VaultBlock.OMINOUS).generate((var8x, var9x) -> {
         ...
         switch(var8x) {
         case INACTIVE:
            var10000 = Variant.variant().with(VariantProperties.MODEL, var9x ? var14 : var6);
            break;
         case ACTIVE:
            var10000 = Variant.variant().with(VariantProperties.MODEL, var9x ? var15 : var7);
            break;
         case UNLOCKING:
            var10000 = Variant.variant().with(VariantProperties.MODEL, var9x ? var16 : var8);
            break;
         case EJECTING:
            var10000 = Variant.variant().with(VariantProperties.MODEL, var9x ? var17 : var9);
            break;
         default:
            throw new MatchException((String)null, (Throwable)null);
         }
   ...
   private Variant applyRotation(FrontAndTop var1, Variant var2) {
      ...
      default:
         throw new UnsupportedOperationException("Rotation " + String.valueOf(var1) + " can't be expressed with existing x and y values");
      }
   }
