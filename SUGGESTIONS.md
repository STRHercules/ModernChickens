...
- Teach the "book training" mechanic to respect a configuration flag so modpacks can choose whether a smart chicken item or entity should appear, keeping both automation- and livestock-focused setups happy without code edits.
